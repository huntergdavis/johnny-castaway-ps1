...
- Current VISITOR3-low fixed-layout cleanup headroom promotion — `VIST3LOW.FG2` now uses previous-visible cleanup while preserving file size, offsets, entry table sizes, and LBA. Logical active payload drops `425729 -> 405835`, cleanup restore bytes drop `456786 -> 53456`, runtime restore bytes drop `467962 -> 64632`, max restore bytes drop `293544 -> 2962`, upload bytes drop `18113920 -> 17494400`, and the five-yellow canary stays exact-flat at the same public rollup.
