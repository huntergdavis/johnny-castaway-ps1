...
| Headless perf | **126 / 126** scene/tide rows are routed and timing-bearing; public-capped average is **+0.3414% over target / 99.6691% target speed** after the VISITOR3 high-only 64 KiB clean-relief window promotion. Live battle card at [/perf/](https://hunterdavis.com/johnny-castaway-ps1/perf/) · CSV at [`performance-scene-matrix.csv`](docs/ps1/performance-scene-matrix.csv) |
...
- Current allocator-era optimization checkpoint — VISITOR3 high improves from `1232/1033` to `1118/1041` and VISITOR3 low from `1231/1040` to `1107/1042` by retaining the tiny stage1 prefetch frame buffer under clean-memory relief and allowing a high-tide-only `64 KiB` stream window. The current under-green canary also refreshes WALKSTUF1 high to `1475/1433`, WALKSTUF1 low to `1479/1435`, BUILDING2 high/low to `1351/1311` and `1339/1315`, and BUILDING4 high/low to `2847/2816` and `2853/2816`.
