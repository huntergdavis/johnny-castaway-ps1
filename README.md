...
| Headless perf battle card | **74 / 126** scene/tide variants measured; **44 / 63** scenes have at least one timed variant; measured average is **+12.5% over target / 89.4% target speed** |
| Latest perf matrix run | **`2026-04-29T12:37:06`** (`last_run_at` in the CSV) |
