...
Post-`v0.8.12-ps1` mainline also promotes `building2-high-frame172-inplace-v877` as a same-speed preserve-offset payload trim: entry `172` / source frame `231` shrinks `1831 -> 851` bytes, active payload drops `674798 -> 673818`, and BUILDING2 high remains exact-flat at `1602/1351/1311`, overrun `40`, blocking/refill `54/18`, reads/read time `58/257`, and due `7`.
