...
| Latest perf matrix run | **`2026-04-30T18:54:48`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v56-walkstuf1high-base84`; earlier follow-up rows use `compact-fgp3-v55-walkstuf1high-derived-prime` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
