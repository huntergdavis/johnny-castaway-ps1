...
| Headless perf | **126 / 126** scene/tide rows are routed and timing-bearing; public-capped average is **+0.2425% over target / 99.7608% target speed** after the WALKSTUF1 low `{378..390}` read-group promotion and the exact-flat WALKSTUF1 high entry136 payload trim. Live battle card at [/perf/](https://hunterdavis.com/johnny-castaway-ps1/perf/) · CSV at [`performance-scene-matrix.csv`](docs/ps1/performance-scene-matrix.csv) |
