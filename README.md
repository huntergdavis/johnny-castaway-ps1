...
| Headless perf battle card | **126 / 126** scene/tide variants routed; **120 / 126** have active-loop timing; **63 / 63** scenes have both tide variants measured; timing-bearing average is **+14.9% over target / 88.0% target speed** |
| Latest perf matrix run | **`2026-04-30T11:46:36`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v42-walkstuf1-window32`; earlier follow-up rows use `compact-fgp3-v41-walkstuf1low-indexed8-fgp3` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
