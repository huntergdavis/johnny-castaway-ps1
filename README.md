...
<p align="center">
  Press <strong>START</strong> mid-scene for the pause menu — Resume, Scene Set, Freeplay ON/OFF, Freeplay Options, World Options, Accessibility, and System. Scene Set scrolls the screensaver pool with Left/Right (All Scenes, Fishing Only, …) and commits with Cross or Start; Freeplay Options carries gags, visitors, controls, and clear-screen; World Options carries day/night, tide, raft, holidays, and island position; Accessibility carries captions, sound, ocean ambience, and Sound Test; System carries save, time/date, RNG seed, perf log, reset scene, and next scene.
</p>
