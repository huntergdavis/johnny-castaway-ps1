...
| Headless perf | **126 / 126** scene/tide rows are routed and timing-bearing; public-capped average is **+0.3141% over target / 99.6933% target speed** after the VISITOR3 high setup-segment extension. Live battle card at [/perf/](https://hunterdavis.com/johnny-castaway-ps1/perf/) · CSV at [`performance-scene-matrix.csv`](docs/ps1/performance-scene-matrix.csv) |
...
- Current allocator-era optimization checkpoint — VISITOR3 high improves from `1232/1033` to `1096/1040` and VISITOR3 low from `1231/1040` to `1088/1038` by retaining the tiny stage1 prefetch frame buffer under clean-memory relief, keeping bounded clean-relief stream windows, trimming the high-tide terminal read before resident setup-segment data, and extending high setup segment2 to relative sectors `203..229`. The current under-green canary keeps WALKSTUF1 high at `1475/1433`, WALKSTUF1 low at `1479/1435`, BUILDING2 high/low at `1351/1311` and `1339/1315`, and BUILDING4 high/low at `2847/2816` and `2853/2816`.
