...
| Headless perf battle card | **75 / 126** scene/tide variants measured; **45 / 63** scenes have at least one timed variant; measured average is **+12.6% over target / 89.3% target speed** |
| Latest perf matrix run | **`2026-04-29T12:56:40`** (`last_run_at` in the CSV) |
