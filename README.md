...
Post-`v0.6.12-ps1`, `VISITOR 5` is validated. Its high/low packs use the
generic normal/far-left/far-right multi-view stitch, with scene-specific
hold redistribution so the coconut impact and downed-plane motion are
readable without changing total scene duration.
