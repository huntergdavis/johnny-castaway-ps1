...
| Latest perf matrix run | **`2026-05-06T20:36:09`** (`last_run_at` in the CSV) |
| Perf stats version | Newest optimized rows use `activity11-fgp3-padded-v081`, `building5-fgp3-padded-v080`, `visitor3-low-group170-186-v080b`, `walkstuf1-fgp2-setup-prime-v080`, and `visitor3-setup-prime-192k-v080`; the full row-level version history is in `performance-scene-matrix.csv` |
...
now `+0.8071%` over target / `99.5018%` target speed;
