...
- `main` after `v0.8.7-ps1` — BUILDING2 high now keeps retained read groups `60..72`, `226..242`, and `249..257` on top of the BUILDING6 scene-local slack4 guard, JOHNNY6 compact-FGP3 metadata plus restore-minus-current promotion, WALKSTUF1 high `344..360`, `422..434`, and `444..456`, VISITOR3 low tail pack compaction, the WALKSTUF1 low staged-prepare fallback, and a current-layout VISITOR5 high refresh. Public rollup is now `+0.3178%` over target / `99.6884%` target speed; BUILDING2 high is `1351/1313`, WALKSTUF1 high stays `1480/1432` while loop reads drop to `65`, and VISITOR5 high is `1107/1090`.
