...
Post-`v0.8.12-ps1` mainline also promotes BUILDING2 high preserve-offset payload trims through `building2-high-frame171-inplace-v879`: entry `172` / source frame `231` shrinks `1831 -> 851` bytes, entry `171` / source frame `228` shrinks `1980 -> 1025` bytes, active payload drops `674798 -> 672863`, and BUILDING2 high remains exact-flat at `1602/1351/1311`, overrun `40`, blocking/refill `54/18`, reads/read time `58/257`, and due `7`.
