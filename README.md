...
| Latest perf matrix run | **`2026-04-29T19:08:18`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v4-visitor6low`; STAND12-low remains `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
