...
- Current BUILDING2-high no-decode trim-draw-tail promotion — `BUILDING2.FG2` trims entries `67`, `69`, `70`, `71`, and `72` while preserving file size and LBA. Active payload drops `574094 -> 548293`; B2-high improves to `1341/1313` / `97.912%` target speed with overrun `28`, blocking `47`, and refill overrun `14`, while the other four yellow canary rows stay flat.
