...
| Headless perf | **126 / 126** scene/tide rows are routed and timing-bearing; public-capped average is **+0.5371% over target / 99.5143% target speed** after the allocator-era targeted setup-segment promotion. Live battle card at [/perf/](https://hunterdavis.com/johnny-castaway-ps1/perf/) · CSV at [`performance-scene-matrix.csv`](docs/ps1/performance-scene-matrix.csv) |
...
- Current allocator-era optimization checkpoint — targeted dual setup segments move WALKSTUF1 high from `1509/1425` to `1489/1430` and WALKSTUF1 low from `1507/1426` to `1477/1434`, dropping W1 high/low out of orange. BUILDING2 high now uses allocator-safe CACHE setup slices at `3..35` and `202..242`, reducing loop reads/read time `57/246 -> 47/208` while keeping the focused allocator run measured.
