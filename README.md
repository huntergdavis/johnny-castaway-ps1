...
| Headless perf battle card | **73 / 126** scene/tide variants measured; **43 / 63** scenes have at least one timed variant; measured average is **+12.7% over target / 89.3% target speed** |
| Latest perf matrix run | **`2026-04-29T12:33:29`** (`last_run_at` in the CSV) |
