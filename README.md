...
| Latest perf matrix run | **`2026-04-30T12:26:37`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v44-walkstuf1-high-window54`; earlier follow-up rows use `compact-fgp3-v43-walkstuf1-split-window` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
