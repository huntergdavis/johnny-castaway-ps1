...
| Latest perf matrix run | **`2026-04-30T16:55:34`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v52-visitor3high-prime`; earlier follow-up rows use `compact-fgp3-v51-building6-window` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
