...
| Latest perf matrix run | **`2026-04-30T13:18:41`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v46-johnny4low-auto-prime`; earlier follow-up rows use `compact-fgp3-v45-activity8-auto-prime` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
