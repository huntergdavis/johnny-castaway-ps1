...
Latest accepted headless performance work converts `activity9` high/low to
padded pal4 FGP3 temporal-residual packs. The on-disc CD footprint stays fixed
at `1745484` bytes per tide while runtime payload drops to `1453793` bytes;
high improves `2185/2049 -> 2101/2056` and low improves
`2197/2054 -> 2103/2053`. The timing-bearing average is now `+0.8745%` over
target / `99.4479%` target speed; since the compact full-matrix baseline was about
