...
| Latest perf matrix run | **`2026-04-30T08:42:40`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v37-fishing7high-prime`; earlier follow-up rows use `compact-fgp3-v36-johnny3high-prime` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
