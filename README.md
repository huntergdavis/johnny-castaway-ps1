...
| Headless perf battle card | **76 / 126** scene/tide variants measured; **46 / 63** scenes have at least one timed variant; measured average is **+12.8% over target / 89.2% target speed** |
| Latest perf matrix run | **`2026-04-29T13:36:18`** (`last_run_at` in the CSV) |
