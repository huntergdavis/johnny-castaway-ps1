...
- Current W1-low cleanup-headroom promotion — `WALK1LOW.FG2` now uses previous-visible cleanup compaction on late frames `194`, `196`, `198`, `200`, `202`, `206`, `208`, and `210`. Active low-pack payload drops `764658 -> 755808`, late cleanup restore bytes drop `49892 -> 574`, pack footprint/LBA stay fixed, and the refreshed five-yellow canary stays exact-flat.
