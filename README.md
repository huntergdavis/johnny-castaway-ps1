...
| Latest perf matrix run | **`2026-04-30T12:06:54`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v43-walkstuf1-split-window`; earlier follow-up rows use `compact-fgp3-v42-walkstuf1-window32` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
