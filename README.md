...
| Latest perf matrix run | **`2026-04-29T20:45:41`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v9-stand2high`; recent follow-up rows include `compact-fgp3-v8-stand6low`, `compact-fgp3-v7-stand4low`, `compact-fgp3-v6-stand5low`, `compact-fgp3-v5-visitor4high`, `compact-fgp3-v4-visitor6low`, `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
