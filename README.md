...
| Latest perf matrix run | **`2026-04-30T19:18:15`** (`last_run_at` in the CSV) |
| Perf stats version | Latest refreshed rows use `compact-fgp3-v57-policy-table-refactor`; earlier follow-up rows use `compact-fgp3-v49-walkstuf2-auto-prime` through `compact-fgp3-v29-smallprime`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
