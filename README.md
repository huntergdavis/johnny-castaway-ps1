...
| Latest perf matrix run | **`2026-04-30T15:15:13`** (`last_run_at` in the CSV) |
| Perf stats version | Latest rows use `compact-fgp3-v51-building6-window`; earlier follow-up rows use `compact-fgp3-v50-building4-window` through `compact-fgp3-v3-stand12low`; full-matrix baseline rows remain `compact-fgp3-v2-fullmatrix` |
