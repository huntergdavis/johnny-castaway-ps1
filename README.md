...
| Headless perf | **126 / 126** scene/tide rows are routed and timing-bearing; public-capped average is **+0.3367% over target / 99.6731% target speed** after the VISITOR3 high-only 68 KiB clean-relief window promotion. Live battle card at [/perf/](https://hunterdavis.com/johnny-castaway-ps1/perf/) · CSV at [`performance-scene-matrix.csv`](docs/ps1/performance-scene-matrix.csv) |
...
- Current allocator-era optimization checkpoint — VISITOR3 high improves from `1232/1033` to `1113/1042` and VISITOR3 low from `1231/1040` to `1107/1042` by retaining the tiny stage1 prefetch frame buffer under clean-memory relief and allowing a high-tide-only `68 KiB` stream window. The current under-green canary keeps WALKSTUF1 high at `1475/1433`, WALKSTUF1 low at `1479/1435`, BUILDING2 high/low at `1351/1311` and `1339/1315`, and BUILDING4 high/low at `2847/2816` and `2853/2816`.
