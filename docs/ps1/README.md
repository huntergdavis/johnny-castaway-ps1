...
Post-`v0.6.12-ps1`, `VISITOR 4`, `VISITOR 5`, and `VISITOR 6` are
validated. VISITOR4 and VISITOR5 use the generic normal/far-left/far-right
multi-view stitch; VISITOR5 also redistributes hold time into the coconut
impact/downed-plane rows. VISITOR6 adds a narrow full-host impact-delta
injection over source frames 120:141 because the tree shake/strike pixels are
background-owned in the host render.
