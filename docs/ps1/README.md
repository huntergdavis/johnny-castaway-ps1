...
late-tail work-volume clips plus the W1-high frame55/frame138/frame51 offscreen clips, and the WALKSTUF1 high late-tail physical
...
draw-span work-volume clips, the W1-high frame55/frame138/frame51 offscreen clips, plus the JOHNNY1 low refresh; the raw signed
...
offscreen frame `55`, frame `138`, and frame `51` draw streams. It is still a same-speed row at `1764`,
...
`17296/134136/776856 -> 17141/133396/760361`; due misses stay `16`, pack
LBA/sectors stay `24883/750`, and the PS-EXE bucket stays `217088`. The tail
groups, physical compaction, and frame55/frame138/frame51 clips are same-speed work reductions,
