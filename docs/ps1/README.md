...
`365..381` grouped-read pass: `-0.0670%` over target / `100.1368%` target
...
current timing-bearing rows now average `-0.0670%` over target / `100.1368%`
...
restore-minus-current promotions plus the current grouped-read promotions.
