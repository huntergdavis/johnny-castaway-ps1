...
draw-tail trim, the WALKSTUF1 high/low late-tail work-volume clips plus the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips, the W1-high frame51/frame49/frame47/frame45/frame43/frame138 preserve-offset payload shrinks, the WALKSTUF1 low `394..410`
...
`walkstuf1-low-frame107-inplace-v876`. The
...
draw-span work-volume clips, the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips plus the W1-high frame51/frame49/frame47/frame45/frame43/frame138 in-place payload shrinks, the W1-low frame79/frame81/frame129/frame139/frame87/frame89/frame98/frame27/frame101/frame93/frame94/frame97/frame99/frame100/frame134/frame91/frame92/frame95/frame140/frame108/frame109/frame107 in-place payload shrinks, plus the JOHNNY1 low refresh; the raw signed
...
offscreen frame `55`, frame `138`, frame `51`, frame `49`, frame `47`, frame `45`, frame `43`, frame `56`, frame `57`, frame `136`, frame `135`, and frame `139` draw streams, and shrinks frames `51`, `49`, `47`, `45`, `43`, and `138` in place with preserved offsets. It is still a same-speed row at `1764`,
active loop/target `1476/1434`, overrun `42`, and blocking/refill `81/23`, but
active payload drops `918345 -> 860574`, CD sectors `605 -> 586`, loop
...
groups, physical compaction, frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 clips, and frame51/frame49/frame47/frame45/frame43/frame138 in-place shrinks are same-speed work reductions,
...
through v726, the  no-shift
...
`145`, `75`, `76`, `77`, `130`, `135`, `1`, `88`, `90`, `3`, `53`, `136`, `79`, `81`, `129`, `139`, `87`, `89`, `98`, `27`, `101`, `93`, `94`, `97`, `99`, `100`, `134`, `91`, `92`, `95`, `140`, `108`, `109`, and `107`, the
...
while active payload drops `879801 -> 790322` without moving pack offsets,
