...
| Headless perf battle card | **126 / 126** variants routed; **126 / 126** timing-bearing; **+0.2702% public over target / 99.7342% public target speed** |
...
draw-tail trim, the WALKSTUF1 high/low late-tail work-volume clips plus the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips, the W1-high frame51/frame49/frame47/frame45/frame43 preserve-offset payload shrinks, the WALKSTUF1 low `394..410`
...
retained-read wins. The
public battle card is now `+0.2702%` over target /
`99.7342%` target speed across all 126
...
draw-span work-volume clips, the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips plus the W1-high frame51/frame49/frame47/frame45/frame43 in-place payload shrinks, plus the JOHNNY1 low refresh; the raw signed
optimization matrix is `-0.4969%` / `100.5165%`.
...
offscreen frame `55`, frame `138`, frame `51`, frame `49`, frame `47`, frame `45`, frame `43`, frame `56`, frame `57`, frame `136`, frame `135`, and frame `139` draw streams, and shrinks frames `51`, `49`, `47`, `45`, and `43` in place with preserved offsets. It is still a same-speed row at `1764`,
active loop/target `1476/1434`, overrun `42`, and blocking/refill `81/23`, but
active payload drops `918345 -> 861486`, CD sectors `605 -> 586`, loop
...
groups, physical compaction, frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 clips, and frame51/frame49/frame47/frame45/frame43 in-place shrinks are same-speed work reductions,
...
through v726, the v747/v749/v750/v751/v753/v755/v756/v757/v759/v762/v763/v766/v767/v769/v770/v771/v772/v773/v774/v775/v776/v777/v779/v780/v781/v782/v783/v784/v785/v786/v787/v788/v789/v790/v791 no-shift
in-place shrinks for frames `51`, `49`, `47`, `61`, `62`, `58`, `45`, `37`,
`35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, `32`, `133`, `5`, `141`, `70`, `30`, `6`, `71`, `72`, `142`, `73`, `131`, `74`, `19`, `28`, `138`, `145`, `75`, and `76`, and the v760 bounded CD fast-poll restoration. Low remains
`1478/1431` at `96.82%` target speed with overrun `47`,
blocking/refill `64/20`, loop reads/read time `60/272`, and due misses `11`,
while active payload drops `879801 -> 801103` without moving pack offsets,
...
`92`, `91`, `90`, and `89`. All stay
exact-flat at `1351/1311`, overrun `40`, blocking/refill `54/18`, and
reads/due `58/7`, while dropping runtime frame rows/spans/pixels from
