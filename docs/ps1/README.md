...
draw-tail trim, the WALKSTUF1 high/low late-tail work-volume clips plus the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57 offscreen clips, the WALKSTUF1 low `394..410`
...
draw-span work-volume clips, the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57 offscreen clips, plus the JOHNNY1 low refresh; the raw signed
...
offscreen frame `55`, frame `138`, frame `51`, frame `49`, frame `47`, frame `45`, frame `43`, frame `56`, and frame `57` draw streams. It is still a same-speed row at `1764`,
...
`17296/134136/776856 -> 16863/130147/733951`; due misses stay `16`, pack
LBA/sectors stay `24883/750`, and the PS-EXE bucket stays `217088`. The tail
groups, physical compaction, and frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57 clips are same-speed work reductions,
