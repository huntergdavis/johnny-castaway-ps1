...
draw-tail trim, the WALKSTUF1 high/low late-tail work-volume clips plus the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips, the W1-high frame51/frame49/frame47/frame45 preserve-offset payload shrinks, the WALKSTUF1 low `394..410`
...
draw-span work-volume clips, the W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 offscreen clips plus the W1-high frame51/frame49/frame47/frame45 in-place payload shrinks, plus the JOHNNY1 low refresh; the raw signed
...
offscreen frame `55`, frame `138`, frame `51`, frame `49`, frame `47`, frame `45`, frame `43`, frame `56`, frame `57`, frame `136`, frame `135`, and frame `139` draw streams, and shrinks frames `51`, `49`, `47`, and `45` in place with preserved offsets. It is still a same-speed row at `1764`,
active loop/target `1476/1434`, overrun `42`, and blocking/refill `81/23`, but
active payload drops `918345 -> 864830`, CD sectors `605 -> 586`, loop
...
groups, physical compaction, frame55/frame138/frame51/frame49/frame47/frame45/frame43/frame56/frame57/frame136/frame135/frame139 clips, and frame51/frame49/frame47/frame45 in-place shrinks are same-speed work reductions,
