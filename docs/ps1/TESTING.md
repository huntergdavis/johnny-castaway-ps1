...
`walkstuf1-low-frame91-inplace-v870` shrinks low entry `91` / source frame
`166` in place after the v869 frame134 trim, preserving all payload offsets
while cutting that entry `5545 -> 5387` bytes. Low repeats at scene `1769`,
...
`791103 -> 790945`, and the no-shift lane drops `879801 -> 790945`.
