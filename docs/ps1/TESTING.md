...
`walkstuf1-high-frame49-inplace-v841` shrinks high entry `49` / source frame
`59` in place after the v839 frame51 shrink, preserving all payload offsets
while cutting that entry `5269 -> 770` bytes.
...
`918345 -> 872690`, CD sectors `605 -> 586`, and loop reads/read
time `65/282 -> 63/276`.
