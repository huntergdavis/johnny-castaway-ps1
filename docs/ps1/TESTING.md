...
`walkstuf1-low-frame79-inplace-v849` shrinks low entry `79` / source frame
`140` in place after the v847 frame136 trim, preserving all payload
offsets while cutting that entry `4992 -> 4264` bytes.
...
`795483 -> 794755`, and the no-shift lane drops `879801 -> 794755`.
