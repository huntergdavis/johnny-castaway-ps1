...
| Timing-bearing average over target | `+0.5%` (`0.4933%` exact, public-capped) |
| Timing-bearing average target speed | `99.5%` (`99.5091%` exact, public-capped) |
| Latest perf matrix run | `2026-05-08T13:52:27` |
