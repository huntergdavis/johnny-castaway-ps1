...
`building2-high-frame170-inplace-v887` trims entry `170` / source frame `226`
after v877/v879/v880 trimmed entries `172` / source frame `231`, `171` /
source frame `228`, and `96` / source frame `119`, preserving all payload
offsets, pack LBA/sectors, and the PS-EXE bucket. Entries `172`, `171`, `96`,
and `170` shrink `1831 -> 851`, `1980 -> 1025`, `8781 -> 7944`, and
`1683 -> 1186` bytes, and active payload drops `674798 -> 671529`;
...
`building2-high-frame170-inplace-v887` trims entry `170` / source frame `226`
after v877/v879/v880 trimmed entries `172`, `171`, and `96`, and v703 added frame `89` on
...
active payload drops `674798 -> 671529` with fixed pack LBA/sectors and
PS-EXE bucket.
