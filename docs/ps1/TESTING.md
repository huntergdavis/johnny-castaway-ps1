...
Latest promoted VISITOR3 note: `visitor3-high-reanchor-f126-v206` keeps high
flat at `1101/1030` while cutting active payload `527206 -> 511690`, blocking
`108 -> 107`, and loop-read time `108 -> 107`. The high persistent setup
segment for sectors `277..293` still trades setup `scene_vb 1405 -> 1414` for
same-loop CD-pressure relief; low remains on v204 at `1102/1032` with blocking
`124`, loop-read time `131`, and due misses `22`.
...
`visitor3-high-reanchor-f126-v206`,
