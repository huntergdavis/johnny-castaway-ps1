...
`compact-fgp3-v57-policy-table-refactor`; earlier follow-up rows use
`compact-fgp3-v49-walkstuf2-auto-prime` through `compact-fgp3-v29-smallprime`. Six routed rows (`mary3`, `suzy1`, `suzy2`,
