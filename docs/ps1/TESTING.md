...
Latest promoted VISITOR3 note: `visitor3-high-f127-f130-resident-copy-v238`
compacts high frames `117..130` unchanged into the existing `320 KiB`
setup-prime resident window. High improves `1089/1035 -> 1075/1037`, overrun
`54 -> 38`, blocking `83 -> 59`, loop reads `15 -> 11`, loop-read time
`83 -> 59`, and due misses `15 -> 11` while keeping `prefetch_overrun_vb=0`.
