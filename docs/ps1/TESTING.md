...
Latest promoted VISITOR3 note: `visitor3-low-f118-resident-copy-v234` copies
the low-tide frame-118 payload unchanged into the already accepted `150..174`
setup segment. Low improves `1095/1035 -> 1091/1035`, overrun `60 -> 56`,
blocking `108 -> 103`, loop reads `19 -> 18`, loop-read time `115 -> 110`,
and due misses `18 -> 17` while keeping `prefetch_overrun_vb=0`.
...
`visitor3-low-f118-resident-copy-v234`,
