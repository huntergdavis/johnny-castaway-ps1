...
`walkstuf1-low-frame98-inplace-v861` shrinks low entry `98` / source frame
`183` in place after the v860 frame89 trim, preserving all payload offsets
while cutting that entry `4985 -> 4779` bytes. Low repeats at scene `1769`,
...
`792657 -> 792451`, and the no-shift lane drops `879801 -> 792451`.
