...
Latest promoted VISITOR3 note: `visitor3-low-f125126-resident-v227` repacks
low-tide frame-125/frame-126 re-anchor payloads into the already accepted
`150..174` setup segment. Low improves `1098/1034 -> 1095/1035`, overrun
`64 -> 60`, blocking `112 -> 108`, loop reads `20 -> 19`, loop-read time
`119 -> 115`, and due misses `19 -> 18` while keeping `prefetch_overrun_vb=0`.
...
`visitor3-low-f125126-resident-v227`,
