...
`walkstuf1-low-frame111-inplace-v909` shrinks low entry `111` / source frame
`219` in place after the v908 frame110 trim, preserving all payload offsets
while cutting that entry `4974 -> 4940` bytes. Low repeats at scene `1769`,
...
`790267 -> 790233`, and the no-shift lane drops `879801 -> 790233`.
