...
`building2-high-frame173-inplace-v914` trims entry `173` / source frame `235`
...
`219`, plus v896 trimmed entry `169` / source frame `223`, preserving all payload offsets, pack LBA/sectors, and the PS-EXE
bucket. Entries `172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, `168`,
`169`, and `173` shrink `1831 -> 851`, `1980 -> 1025`, `8781 -> 7944`,
`1683 -> 1186`, `8718 -> 8258`, `8876 -> 8637`, `1625 -> 1460`,
`8843 -> 8728`, `1372 -> 1266`, `1820 -> 1495`, and `1765 -> 1134` bytes, and active payload drops `674798 -> 669488`;
...
`building2-high-frame173-inplace-v914` trims entry `173` / source frame `235`
after v877/v879/v880/v887/v888/v889/v890/v891/v892/v896 trimmed entries `172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, `168`, and `169`, and v703 added frame `89` on
...
active payload drops `674798 -> 669488` with fixed pack LBA/sectors and
PS-EXE bucket.
