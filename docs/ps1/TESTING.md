...
`walkstuf1-low-frame136-inplace-v847` shrinks low entry `136` / source frame
`244` in place after the v846 frame53 trim, preserving all payload
offsets while cutting that entry `3762 -> 2596` bytes.
...
`796649 -> 795483`, and the no-shift lane drops `879801 -> 795483`.
