...
`building2-high-frame96-inplace-v880` trims entry `96` / source frame `119`
after v877/v879 trimmed entries `172` / source frame `231` and `171` / source
frame `228`, preserving all payload offsets, pack LBA/sectors, and the PS-EXE
bucket. Entries `172`, `171`, and `96` shrink `1831 -> 851`, `1980 -> 1025`,
and `8781 -> 7944` bytes, and active payload drops `674798 -> 672026`;
...
`building2-high-frame96-inplace-v880` trims entry `96` / source frame `119`
after v877/v879 trimmed entries `172` and `171`, and v703 added frame `89` on
...
active payload drops `674798 -> 672026` with fixed pack LBA/sectors and
PS-EXE bucket.
