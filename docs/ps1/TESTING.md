...
Latest promoted VISITOR3 note: `visitor3-low-segment281-305-v204` keeps high
flat at `1101/1030` and moves low `1108/1028 -> 1102/1032`. The persistent
setup segment for sectors `281..305` trades low setup `scene_vb 1408 -> 1415`
for active-loop relief: overrun `80 -> 70`, blocking `139 -> 124`, loop reads
`27 -> 23`, loop-read time `148 -> 131`, and due misses `25 -> 22`.
