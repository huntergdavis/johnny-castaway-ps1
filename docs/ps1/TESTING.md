...
`walkstuf1-low-frame140-inplace-v873` shrinks low entry `140` / source frame
`248` in place after the v872 frame95 trim, preserving all payload offsets
while cutting that entry `4296 -> 4205` bytes. Low repeats at scene `1769`,
...
`790629 -> 790538`, and the no-shift lane drops `879801 -> 790538`.
