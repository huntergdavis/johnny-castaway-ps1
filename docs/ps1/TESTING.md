...
Latest promoted VISITOR3 note: `visitor3-high-segment277-293-v205` keeps high
flat at `1101/1030` while cutting blocking `114 -> 108`, loop reads `22 ->
20`, loop-read time `116 -> 108`, and due misses `21 -> 20`. The high
persistent setup segment for sectors `277..293` trades setup `scene_vb 1405
-> 1414` for same-loop CD-pressure relief; low remains on v204 at `1102/1032`
with blocking `124`, loop-read time `131`, and due misses `22`.

Latest rejected VISITOR3 v183-v203 note: low-tide precursor motion-copy frames
...
motion-marker dispatch, both-tide frame `125` re-anchor, and low frame `127`
re-anchor are log-only
failures.
...
`visitor3-high-segment277-293-v205`,
