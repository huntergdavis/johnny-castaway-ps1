...
`walkstuf1-low-frame99-inplace-v867` shrinks low entry `99` / source frame
`186` in place after the v866 frame97 trim, preserving all payload offsets
while cutting that entry `4766 -> 4600` bytes. Low repeats at scene `1769`,
...
`791597 -> 791431`, and the no-shift lane drops `879801 -> 791431`.
