...
`walkstuf1-low-frame53-inplace-v846` shrinks low entry `53` / source frame
`63` in place after the v817 retained-read promotion, preserving all payload
offsets while cutting that entry `3893 -> 2463` bytes.
...
`798079 -> 796649`, and the no-shift lane drops `879801 -> 796649`.
