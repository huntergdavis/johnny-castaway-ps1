...
`walkstuf1-low-frame100-inplace-v868` shrinks low entry `100` / source frame
`189` in place after the v867 frame99 trim, preserving all payload offsets
while cutting that entry `4683 -> 4517` bytes. Low repeats at scene `1769`,
...
`791431 -> 791265`, and the no-shift lane drops `879801 -> 791265`.
