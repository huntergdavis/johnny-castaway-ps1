...
`walkstuf1-low-frame134-inplace-v869` shrinks low entry `134` / source frame
`242` in place after the v868 frame100 trim, preserving all payload offsets
while cutting that entry `4397 -> 4235` bytes. Low repeats at scene `1769`,
...
`791265 -> 791103`, and the no-shift lane drops `879801 -> 791103`.
