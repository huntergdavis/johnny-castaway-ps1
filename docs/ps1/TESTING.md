...
`walkstuf1-low-frame109-inplace-v875` shrinks low entry `109` / source frame
`217` in place after the v874 frame108 trim, preserving all payload offsets
while cutting that entry `4365 -> 4292` bytes. Low repeats at scene `1769`,
...
`790454 -> 790381`, and the no-shift lane drops `879801 -> 790381`.
