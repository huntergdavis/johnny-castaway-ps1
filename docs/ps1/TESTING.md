...
`walkstuf1-high-frame55-offscreen-v731` clips the fully offscreen high frame
`55` on top of v657. High stays exact-flat at `1764`, active loop/target
`1476/1434`, blocking/refill `81/23`, loop reads/read time `63/275`, and due
`16`, while runtime rows/spans/pixels drop
`17296/134136/776856 -> 17235/134039/768120`; v657 still provides the active
