...
`walkstuf1-low-frame97-inplace-v866` shrinks low entry `97` / source frame
`179` in place after the v865 frame94 trim, preserving all payload offsets
while cutting that entry `4825 -> 4658` bytes. Low repeats at scene `1769`,
...
`791764 -> 791597`, and the no-shift lane drops `879801 -> 791597`.
