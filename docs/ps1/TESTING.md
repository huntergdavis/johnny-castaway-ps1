...
`walkstuf1-low-frame27-inplace-v862` shrinks low entry `27` / source frame
`34` in place after the v861 frame98 trim, preserving all payload offsets
while cutting that entry `7015 -> 6830` bytes. Low repeats at scene `1769`,
...
`792451 -> 792266`, and the no-shift lane drops `879801 -> 792266`.
