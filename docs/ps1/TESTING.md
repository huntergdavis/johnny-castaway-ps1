...
`walkstuf1-low-frame139-inplace-v855` shrinks low entry `139` / source frame
`247` in place after the v853 frame129 trim, preserving all payload
offsets while cutting that entry `4011 -> 3668` bytes.
...
`793537 -> 793194`, and the no-shift lane drops `879801 -> 793194`.
