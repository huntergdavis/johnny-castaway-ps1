...
Latest promoted VISITOR3 note: `visitor3-f124-sparse-motion-v188` keeps loop
timing flat at `1104/1030` high and `1108/1028` low, cuts active payload by
`14592` bytes per tide, cuts blocking to `126/142`, and preserves fixed LBAs
