...
`walkstuf1-low-frame94-inplace-v865` shrinks low entry `94` / source frame
`171` in place after the v864 frame93 trim, preserving all payload offsets
while cutting that entry `5544 -> 5377` bytes. Low repeats at scene `1769`,
...
`791931 -> 791764`, and the no-shift lane drops `879801 -> 791764`.
