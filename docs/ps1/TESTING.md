...
`walkstuf1-low-frame93-inplace-v864` shrinks low entry `93` / source frame
`170` in place after the v863 frame101 trim, preserving all payload offsets
while cutting that entry `5661 -> 5494` bytes. Low repeats at scene `1769`,
...
`792098 -> 791931`, and the no-shift lane drops `879801 -> 791931`.
