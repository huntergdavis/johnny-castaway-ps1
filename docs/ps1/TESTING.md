...
`walkstuf1-high-frame47-inplace-v842` shrinks high entry `47` / source frame
`57` in place after the v839/v841 frame51/frame49 shrinks, preserving all
payload offsets while cutting that entry `7399 -> 3158` bytes.
...
`918345 -> 868449`, CD sectors `605 -> 586`, and loop reads/read
time `65/282 -> 63/276`.
