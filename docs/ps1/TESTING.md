...
`compact-fgp3-v5-visitor4high`; VISITOR6-low remains `compact-fgp3-v4-visitor6low`; STAND12-low remains `compact-fgp3-v3-stand12low`. Six routed rows (`mary3`, `suzy1`, `suzy2`,
