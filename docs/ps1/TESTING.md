...
`walkstuf1-low-frame92-inplace-v871` shrinks low entry `92` / source frame
`168` in place after the v870 frame91 trim, preserving all payload offsets
while cutting that entry `6035 -> 5877` bytes. Low repeats at scene `1769`,
...
`790945 -> 790787`, and the no-shift lane drops `879801 -> 790787`.
