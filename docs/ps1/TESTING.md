...
`walkstuf1-low-frame129-inplace-v853` shrinks low entry `129` / source frame
`237` in place after the v852 frame81 trim, preserving all payload
offsets while cutting that entry `5093 -> 4535` bytes.
...
`794095 -> 793537`, and the no-shift lane drops `879801 -> 793537`.
