...
`walkstuf1-high-frame138-offscreen-v732` clips the high frame `138` offscreen
spans on top of the v731 frame55 clip. High stays exact-flat at `1764`, active
loop/target `1476/1434`, blocking/refill `81/23`, loop reads/read time
`63/275`, and due `16`, while runtime rows/spans/pixels drop
`17235/134039/768120 -> 17235/134035/766315`; v657 still provides the active
