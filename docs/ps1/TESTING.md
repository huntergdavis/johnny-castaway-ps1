...
`building2-high-frame91-offscreen-v701` adds frame `91` after v700 proved
frame `92`, v698 proved the safe `94..104` tail, and v664 proved late frames
`168..177`. Timing/CD stays
exact-flat at `1602`, active loop/target `1351/1311`, overrun `40`,
blocking/refill `54/18`, and reads/due `58/7`, while runtime frame
rows/spans/pixels drop `18144/110717/468636 -> 18069/107577/454211` with
