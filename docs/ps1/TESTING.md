...
Latest promoted WALKSTUF1 note: `walkstuf1-high-gap1-windowprefetch-slack4-v288`
keeps the high-tide-only `201..213` read group, applies the gap1 early-prefix
pack shape, and skips high-tide speculative window prefetch when held slack is
only the default 3 VBlanks. High improves `1488/1426 -> 1477/1431`, overrun
`62 -> 46`, blocking `92 -> 90`, hidden refill `27 -> 19`, and loop-read time
`309 -> 285`; broad controls stay flat.
