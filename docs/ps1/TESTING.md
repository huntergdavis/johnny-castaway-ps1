...
Latest promoted VISITOR3 note: `visitor3-low-f127-resident-copy-v237` compacts
the already accepted `150..174` low resident segment, moves frames `125/126`
earlier unchanged, and copies frame `127` unchanged into the freed resident
tail. Low improves `1091/1035 -> 1088/1035`, overrun `56 -> 53`, blocking
`103 -> 95`, loop reads `18 -> 17`, loop-read time `110 -> 102`, and due
misses `17 -> 16` while keeping `prefetch_overrun_vb=0`.
