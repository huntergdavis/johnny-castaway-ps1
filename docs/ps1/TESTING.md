...
| Stats version | mixed; current five-yellow timing rows are stamped `b2-prev-visible-cleanup`; full row-level versions remain in `performance-scene-matrix.csv` |
