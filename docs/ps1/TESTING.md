...
`compact-fgp3-v56-walkstuf1high-base84`; earlier follow-up rows use
`compact-fgp3-v55-walkstuf1high-derived-prime` through `compact-fgp3-v3-stand12low`. Six routed rows (`mary3`, `suzy1`, `suzy2`,
