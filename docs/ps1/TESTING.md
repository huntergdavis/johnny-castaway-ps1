...
`walkstuf1-low-frame107-inplace-v876` shrinks low entry `107` / source frame
`214` in place after the v875 frame109 trim, preserving all payload offsets
while cutting that entry `1959 -> 1900` bytes. Low repeats at scene `1769`,
