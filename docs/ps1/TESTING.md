...
`walkstuf1-low-frame110-inplace-v908` shrinks low entry `110` / source frame
`218` in place after the v876 frame107 trim, preserving all payload offsets
while cutting that entry `4671 -> 4616` bytes. Low repeats at scene `1769`,
...
`790322 -> 790267`, and the no-shift lane drops `879801 -> 790267`.

Latest promoted BUILDING2 high payload note:
`building2-high-frame169-inplace-v896` trims entry `169` / source frame `223`
...
`219`, preserving all payload offsets, pack LBA/sectors, and the PS-EXE
bucket. Entries `172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, `168`,
and `169` shrink `1831 -> 851`, `1980 -> 1025`, `8781 -> 7944`,
`1683 -> 1186`, `8718 -> 8258`, `8876 -> 8637`, `1625 -> 1460`,
`8843 -> 8728`, `1372 -> 1266`, and `1820 -> 1495` bytes, and active payload drops `674798 -> 670119`;
...
`building2-high-frame169-inplace-v896` trims entry `169` / source frame `223`
after v877/v879/v880/v887/v888/v889/v890/v891/v892 trimmed entries `172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, and `168`, and v703 added frame `89` on
...
active payload drops `674798 -> 670119` with fixed pack LBA/sectors and
PS-EXE bucket.
