...
Latest promoted VISITOR3 note: `visitor3-high-f131-resident-alias121123-v299`
...
refill stays `0`. Low remains `visitor3-low-alias-noop114117-v292` at
`1075/1039`, blocking `67`, loop reads `12`, and due misses `12`.
...
improves `1487/1424 -> 1478/1428`, overrun `63 -> 50`, blocking `95 -> 75`,
and loop-read time `305 -> 301`. High remains on
