...
Latest promoted VISITOR3 note: `visitor3-high-reanchor-f125-v207` keeps high
flat at `1101/1030` while cutting active payload `511690 -> 496661`, blocking
`107 -> 106`, and loop-read time `107 -> 106`. The high persistent setup
