...
`walkstuf1-low-frame108-inplace-v874` shrinks low entry `108` / source frame
`216` in place after the v873 frame140 trim, preserving all payload offsets
while cutting that entry `4271 -> 4187` bytes. Low repeats at scene `1769`,
...
`790538 -> 790454`, and the no-shift lane drops `879801 -> 790454`.
