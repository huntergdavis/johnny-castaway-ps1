...
`walkstuf1-high-frame51-inplace-v839` shrinks high entry `51` / source frame
`61` in place after the v837 offscreen span lane, preserving all payload
offsets while cutting that entry `5588 -> 770` bytes.
...
`918345 -> 877189`, CD sectors `605 -> 586`, and loop reads/read
time `65/282 -> 63/276`.
