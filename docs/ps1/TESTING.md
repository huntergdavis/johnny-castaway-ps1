...
`walkstuf1-low-frame95-inplace-v872` shrinks low entry `95` / source frame
`173` in place after the v871 frame92 trim, preserving all payload offsets
while cutting that entry `4878 -> 4720` bytes. Low repeats at scene `1769`,
...
`790787 -> 790629`, and the no-shift lane drops `879801 -> 790629`.
