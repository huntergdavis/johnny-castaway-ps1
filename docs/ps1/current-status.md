...
bytes. The v665 follow-up clips the isolated low mid offscreen cluster `133..139`,
also exact-flat, dropping runtime frame rows/spans/pixels
`17298/135025/785455 -> 17292/134774/780557`. The public battle card is now
`+0.2736%` over target /
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  work-volume clipping, and WALKSTUF1 high/low late-tail plus low mid offscreen
  ...
  reads `62` and rows/spans/pixels `17292/134774/780557`, VISITOR3 high is
