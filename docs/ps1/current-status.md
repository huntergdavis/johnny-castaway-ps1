...
**Last updated:** 2026-05-01 (scene ledger at 7/63; `FISHING 8`
...
`FISHING 6`, `FISHING 7`, and `FISHING 8` have been validated under the
...
| Scene playback (fgpilot, `foreground_pilot.c`) | Primary render path; 7/63 scenes fully validated |
...
| **7 / 63** | **2026-05-01** | **Current scene ledger after `FISHING 8` promotion; it shares the same captured-position pin as `FISHING 7`** | **this doc, `scene-status.md`** |
