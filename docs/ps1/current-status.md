...
**Last updated:** 2026-05-04 (scene ledger at 32/63; `STAND 11` was
validated as-is on the normal high-tide/night route — same host export
quirk as `STAND 10`, the previously-committed 95 KB FG2 pack was
kept).
...
`STAND 1`-`STAND 11` have been validated
...
`STAND 2`-`STAND 11` are validated on the normal high-tide/night
...
| Scene playback (fgpilot, `foreground_pilot.c`) | Primary render path; 32/63 scenes fully validated |
...
Milestone releases:
- Current main after `v0.6.11-ps1` — promotes `STAND 2`-`STAND 11`
...
| **32 / 63** | **2026-05-04** | **Current scene ledger after `STAND 11` promotion; same host export quirk as `STAND 10`, the previously-committed 95 KB FG2 pack was kept and signed off as-is on the normal high-tide/night route** | **this doc, `scene-status.md`** |
