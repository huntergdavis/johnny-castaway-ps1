...
the VISITOR3-low `16..32` read-group promotion, the VISITOR3-low frame `135`
...
public headless battle card is `+0.2474%` over target / `99.7563%` target
speed).
...
gap-placed D4 speed promotion, and the VISITOR3-low `16..32` read-group
speed promotion, the public battle card is now
`+0.2474%` over target / `99.7563%` target speed; the raw signed optimization
rollup is about `-0.4695%` / `100.4867%`.
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The public battle card is `+0.2474%` / `99.7563%` with `121` green, `5` yellow, and `0` orange rows;
  ...
  VISITOR3 low is `1066/1035` with blocking/read count `73`/`17`, JOHNNY1 high/low are
