...
timing-bearing, and the public headless battle card is `+0.1830%` over target
/ `99.8185%` target speed).
...
`+0.1830%` over target / `99.8185%` target speed; the raw signed optimization
rollup is `-0.5339%` / `100.5488%`.
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The current public battle card is `+0.1830%` / `99.8185%` with `126` green, `0` yellow, and `0` orange rows;
