...
bytes. The v665/v666 follow-ups clip isolated low mid/left offscreen clusters,
also exact-flat, dropping runtime frame rows/spans/pixels from
`17298/135025/785455 -> 16838/130637/737371`. The public battle card is now
`+0.2736%` over target /
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  reads `62` and rows/spans/pixels `16838/130637/737371`, VISITOR3 high is
