...
timing-bearing, and the public headless battle card is `+0.2051%` over target
/ `99.7970%` target speed).
...
`+0.2051%` over target / `99.7970%` target speed; the raw signed optimization
rollup is about `-0.5118%` / `100.5273%`.
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The current public battle card is `+0.2051%` / `99.7970%` with `123` green, `3` yellow, and `0` orange rows;
