...
the VISITOR3-low `72..88` and `16..32` read-group promotions, the VISITOR3-low frame `135`
...
gap-placed D4 speed promotion, and the VISITOR3-low `72..88` plus `16..32` read-group
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  VISITOR3 low is `1070/1039` with blocking/read count `70`/`15`, JOHNNY1 high/low are
