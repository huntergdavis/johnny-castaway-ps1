...
clips, and high v731 adds a frame55 offscreen clip. High stays exact-flat at
`1476/1434` with blocking/refill `81/23`, reads/due `63/16`, while dropping
runtime rows/spans/pixels to `17235/134039/768120`. Low v653 clips frames `202..210`
...
`17298/135025/785455 -> 16272/116912/650623`. The W1-high frame55 follow-up is
also exact-flat and drops high runtime rows/spans/pixels
`17296/134136/776856 -> 17235/134039/768120`. The public battle card is now
`+0.2732%` over target /
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  work-volume clipping, and WALKSTUF1 high/low late-tail plus high frame55 and low mid/left/pre-tail/mid-right/pre-left-edge/post-left/late-left2/frame1/post-mid/frame3/frame140/frame61/frame60/frame62/frame59/frame58/frame63 offscreen
  ...
  `17235/134039/768120`, WALKSTUF1 low is `1478/1431` with loop
