...
`394..410` retained read group after the v653/v705/v802/v846/v847/v849/v852/v853 work-volume chain and
improves to `1477/1431` with blocking/refill `64/20`,
loop reads/read VBlanks `58/266`, and due `11`, while v846/v847/v849/v852/v853 trim frames
`53`, `136`, `79`, `81`, and `129` in place and drop active payload to `793537` without moving offsets, still carrying the
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  plus frame53/frame136/frame79/frame81/frame129 no-shift payload shrinking.
