...
bytes. The v665/v666/v668/v669/v672/v673 follow-ups clip isolated low mid/left/pre-tail/mid-right/pre-left-edge offscreen clusters,
also exact-flat, dropping runtime frame rows/spans/pixels from
`17298/135025/785455 -> 16678/126554/700793`. The public battle card is now
`+0.2736%` over target /
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  work-volume clipping, and WALKSTUF1 high/low late-tail plus low mid/left/pre-tail/mid-right/pre-left-edge offscreen
  ...
  reads `62` and rows/spans/pixels `16678/126554/700793`, VISITOR3 high is
