...
**Last updated:** 2026-05-04 (scene ledger at 29/63; `STAND 8` was
validated after adding a per-frame ocean wave tick to the FG2 runtime
so STAND no-stitch scenes get animated water from the engine instead
of from the foreground-only pack).
...
`STAND 1`, `STAND 2`, `STAND 3`, `STAND 4`, `STAND 5`, `STAND 6`, `STAND 7`, and `STAND 8` have been validated
...
`STAND 2`, `STAND 3`, `STAND 4`, `STAND 5`, `STAND 6`, `STAND 7`, and
`STAND 8` are validated on the normal high-tide/night route.
`STAND 5`-`STAND 8` use the STAND no-stitch export fast path, but that
...
| Scene playback (fgpilot, `foreground_pilot.c`) | Primary render path; 29/63 scenes fully validated |
...
- Current main after `v0.6.11-ps1` — promotes `STAND 2`, `STAND 3`,
  `STAND 4`, `STAND 5`, `STAND 6`, `STAND 7`, and `STAND 8` after
  visual signoff on the normal high-tide/night route. `STAND 5`-
  `STAND 8` ride the STAND no-stitch export fast path with a full-frame
