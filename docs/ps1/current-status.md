...
timing-bearing, and the public headless battle card is `+0.2233%` over target
/ `99.7793%` target speed).
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The current public battle card is `+0.2233%` / `99.7793%` with `122` green, `4` yellow, and `0` orange rows;
