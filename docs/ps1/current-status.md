...
clips, and high v832 adds frame55/frame138/frame51/frame49/frame47/frame45/frame43 offscreen clips. High stays exact-flat at
`1476/1434` with blocking/refill `81/23`, reads/due `63/16`, while dropping
runtime rows/spans/pixels to `16985/131136/741064`. Low v817 adds the
...
`17298/135025/785455 -> 16272/116912/650623`. The W1-high frame55/frame138/frame51/frame49/frame47/frame45/frame43 follow-up is
also exact-flat and drops high runtime rows/spans/pixels
`17296/134136/776856 -> 16985/131136/741064`. BUILDING4 low v827 now carries
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  work-volume clipping, and WALKSTUF1 high/low late-tail plus high frame55/frame138/frame51/frame49/frame47/frame45/frame43 and low mid/left/pre-tail/mid-right/pre-left-edge/post-left/late-left2/frame1/post-mid/frame3/frame140/frame61/frame60/frame62/frame59/frame58/frame63 offscreen
  ...
  `16985/131136/741064`, WALKSTUF1 low is `1477/1431` with loop
