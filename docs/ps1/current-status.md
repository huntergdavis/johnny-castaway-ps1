...
the BUILDING2 low `226..262` + clean80 green promotion;
all 63 scenes remain validated, all 126 high/low rows are timing-bearing, and
the public headless battle card is `+0.2494%` over target / `99.7542%` target
speed).
...
clean80 green promotion, the public battle card is now
`+0.2494%` over target / `99.7542%` target speed;
the raw signed optimization rollup is about `-0.4675%` / `100.4845%`.
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The public battle card is `+0.2494%` / `99.7542%` with `120` green, `6` yellow, and `0` orange rows;
