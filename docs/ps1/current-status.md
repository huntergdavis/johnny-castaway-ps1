...
timing-bearing, and the public headless battle card is `+0.1762%` over target
/ `99.8252%` target speed).
...
`+0.1762%` over target / `99.8252%` target speed; the raw signed optimization
rollup is `-0.5407%` / `100.5555%`.
...
- Current `main` after `v0.8.8-ps1` — promotes the BUILDING2 high `206..230`
  ...
  The current public battle card is `+0.1762%` / `99.8252%` with `126` green, `0` yellow, and `0` orange rows;
