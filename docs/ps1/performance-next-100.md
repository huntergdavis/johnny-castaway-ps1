...
| 6 | BUILDING2 high | Closed by v699 as safe subsets only: frames `168..177` plus `94..104` offscreen clipping remove `9223` pixels, `1759` spans, and `52` frame rows while staying exact-flat, but broad/hot v655 and early `67,69..71` v699 clipping regressed phase. | Do not retry broad/hot/early offscreen clipping for speed. Reopen only for generated scheduler-coupled clipping or upload/restore data that proves fewer rows/spans without changing CD/refill cadence. |
