...
| Hard-coded early read groups | Append-start trace or generated group metadata proves the group can fire; sector `106..117` was exact no-op even with `15` sectors of retained capacity. |
