...
or long-run heap stability. The current all-scene battle card is `13.8570%`
over target / `88.6303%` target speed across `120` timing-bearing rows after
the `mary2-v068-wide-stitch` validation refresh. The
