...
The latest flat size cleanup compiles `events_ps1.c` with `-Os`, keeping all
VBlank/CD/work metrics unchanged while shrinking the ELF to `717796` bytes.
