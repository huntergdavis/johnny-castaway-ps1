...
or long-run heap stability. The current all-scene battle card is `0.8324%`
over target / `99.4776%` target speed across `120` timing-bearing rows after
the `johnny2-fgp3-padded-v081` refresh. The largest remaining absolute gaps
are now VISITOR3, WALKSTUF1, BUILDING2, BUILDING4, BUILDING6, JOHNNY2, and
