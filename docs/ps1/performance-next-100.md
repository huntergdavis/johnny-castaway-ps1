...
or long-run heap stability. The current all-scene battle card is `12.4923%`
over target / `89.4905%` target speed across `120` timing-bearing rows after
the `stand1-v072-current-refresh` baseline correction. The
