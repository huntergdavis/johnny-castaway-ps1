...
`1452 -> 1405`, `440 -> 390`, `361 -> 301`, and `19 -> 8`. The current
all-scene battle card is now `0.7400%` over target / `99.5291%` target speed
across `120` timing-bearing rows. The largest remaining absolute gaps are now
VISITOR3, WALKSTUF1, BUILDING2, BUILDING4, BUILDING6, JOHNNY2, and
