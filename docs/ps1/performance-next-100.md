...
or long-run heap stability. The current all-scene battle card is `13.7135%`
over target / `88.7395%` target speed across `120` timing-bearing rows after
the `visitor3-v072-prefetch-relief` recovery. The
