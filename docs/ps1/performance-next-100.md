...
followed by the WALKSTUF1 low entry65, entry39, entry55, and entry56 payload-only trims, then the
...
entry39/source frame49, entry55/source frame65, and entry56/source frame67 preserve-offset trims keep
every speed-bearing metric exact-flat while reducing active payload another
`13890` bytes to `774883`, so they are banked as payload work only and do not
...
and the W1-low entry65/entry39/entry55/entry56 payload-only trims:
