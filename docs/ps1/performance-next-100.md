...
`+0.1906%` public average over target / `99.8111%` public target speed across
all `126` timing-bearing rows. The raw signed optimization matrix is about
`-0.5263%` / `100.5414%`. Since the compact full-matrix baseline was
...
target-speed points. Bands are now `125` green, `1` yellow, `0` orange, and
