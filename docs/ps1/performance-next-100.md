...
The v205/v206/v207 chain keeps VISITOR3 high loop timing flat at `1101/1030`
while cutting blocking `114 -> 106`, loop reads `22 -> 20`,
loop-read time `116 -> 106`, due misses `21 -> 20`, and active payload
`527206 -> 496661`; the setup tradeoff raises total high `scene_vb 1405 -> 1414`.
