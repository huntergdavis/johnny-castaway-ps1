...
or long-run heap stability. The current all-scene battle card is `13.6273%`
over target / `88.7828%` target speed across `120` timing-bearing rows after
the `walkstuf1-v072-prefetch-relief` recovery. The
