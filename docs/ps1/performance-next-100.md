...
WALKSTUF1 low isolated mid/left/pre-tail/mid-right/pre-left-edge/post-left/late-left2/frame65/post-left-singleton/mid-right-ad/ae/af/frame1/post-mid/frame3/frame140/frame61/frame60/frame62/frame59/frame58/frame63/frame133/frame132/frame5/frame141/frame131/frame19/frame6/frame142/frame130/frame145/frame129 offscreen work-volume clips, the v747/v749/v750/v751/v753 WALKSTUF1 low frame51/frame49/frame47/frame61/frame62 in-place work-volume shrinks, plus the v705 WALKSTUF1 low late-tail subset physical compaction:
...
Latest promoted WALKSTUF1 low work-volume baseline: v747/v749/v750/v751/v753
keep the v726 timing profile exact-flat but shrink frames `51`, `49`, `47`,
`61`, and `62` in-place, preserving every payload offset and the `1535263` byte
pack footprint. Active payload drops `879801 -> 858349`; entries `51`, `49`,
`47`, `61`, and `62` shrink `5588 -> 770`, `5269 -> 770`, `7399 -> 3158`,
`4590 -> 552`, and `4599 -> 743`, and their sector coverage drops `4 -> 1`,
`3 -> 1`, `5 -> 3`, `3 -> 1`, and `4 -> 2`.
