...
`+0.1956%` public average over target / `99.8062%` public target speed across
all `126` timing-bearing rows. The raw signed optimization matrix is about
`-0.5213%` / `100.5366%`. Since the compact full-matrix baseline was
...
target-speed points. Bands are now `124` green, `2` yellow, `0` orange, and
