...
low no-op payload alias, and the v299 VISITOR3 high frame-131 resident-alias
setup-prime copy:
`+0.3215%` public average over target / `99.6847%` public target speed across
all `126` timing-bearing rows. The raw signed optimization matrix is
`-0.4470%` / `100.4685%`. Since the compact full-matrix baseline was about
...
frame-140/tail setup-segment copy, and the v299 high frame-131 resident-alias
setup-prime copy.
...
`blocking_vb=49`, `loop_read_vb=49`, and due misses `9`. The latest low alias
...
`scratch/ps1-perf-iterate/visitor3-high-f131-resident-alias121123-v299-broad-norequire/20260510-033846-2573991/summary.json`;
...
`12`; the v299 VISITOR3 high frame-131 resident-alias copy moves the current
