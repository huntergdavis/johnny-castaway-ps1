...
The VISITOR3 offscreen-clip lane is closed as a standalone pack transform.
...
these pixels visually; any future retry needs a scheduler-costed pack planner
that preserves low-tide phase, not another blind payload rewrite.
