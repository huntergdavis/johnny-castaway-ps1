...
profiles. The current all-scene battle card is now `0.5830%` over target /
`99.6672%` target speed across `120` timing-bearing rows.
...
This checkpoint later moved to `0.5830%` over target / `99.6672%` target
