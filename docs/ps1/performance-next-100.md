...
the v305 WALKSTUF1 low gap6-prefix plus slack-guard promotion, followed by
the v316 WALKSTUF1 high `213..229` read-group/slack4 promotion:
`+0.3326%` public average over target / `99.6742%` public target speed across
all `126` timing-bearing rows. The raw signed optimization matrix is
`-0.4344%` / `100.4566%`. Since the compact full-matrix baseline was about
