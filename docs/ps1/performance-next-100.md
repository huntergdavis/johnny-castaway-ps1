...
BUILDING2 high offscreen work-volume clips, and the v665/v666/v668/v669/v672/v673/v674/v675/v678/v680/v684/v685/v686/v687/v688/v689/v690/v691/v692/v693/v694/v695/v696/v716/v717/v718/v719/v720
WALKSTUF1 low isolated mid/left/pre-tail/mid-right/pre-left-edge/post-left/late-left2/frame65/post-left-singleton/mid-right-ad/ae/af/frame1/post-mid/frame3/frame140/frame61/frame60/frame62/frame59/frame58/frame63/frame133/frame132/frame5/frame141/frame131 offscreen work-volume clips, plus the v705 WALKSTUF1 low late-tail subset physical compaction:
...
`916139 -> 879801` and loop reads/read VBlanks improve `62/281 -> 60/273`.
...
row, and drops runtime rows/spans/pixels to `16266/115769/640323`. Keep these
as same-speed CD/work baselines, not public
...
| 3a | BUILDING2 low | v710 closes whole-pack same-order physical compaction: trimming active payload `660236 -> 538534` caused a structural failure before `JCPERF2`, with `JCWALK: walkClean buffer alloc failed` in the log. | Retry only as subset-scoped physical movement or after an allocator/cleanup memory budget proof; broad low-tide tail compaction is not a safe binary lane. |
