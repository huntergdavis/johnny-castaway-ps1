...
pack pass moves the current all-scene battle card to `0.0502%` over target /
`100.0292%` target speed across `120` timing-bearing rows.
...
`0.0502%` over target / `100.0292%` target speed, with no red timing-bearing
rows remaining. Artifact:
