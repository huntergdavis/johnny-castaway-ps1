...
and `walkstuf1-high-frame47-inplace-v842` shrink entries `51` / source frame
`61`, `49` / source frame `59`, and `47` / source frame `57` inside
`WALKSTUF1.FG2` without moving any payload offsets. Entry `51` drops
`5588 -> 770` bytes, entry `49` drops `5269 -> 770` bytes, entry `47` drops
`7399 -> 3158` bytes, and active payload drops `882007 -> 868449`; file size
...
loop reads/read VBlanks `63/276`, and due misses `16`. Treat v839/v841/v842 as
