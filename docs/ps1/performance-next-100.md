...
setup segment, and the v213/v214 high setup-prime expansions:
`+0.3829%` public average over target / `99.6284%` public target speed across
all `126` timing-bearing rows. The raw signed optimization matrix is
`-0.3856%` / `100.4122%`. Since the compact full-matrix baseline was about
...
the v213 high-only setup-prime expansion from `232 KiB` to `288 KiB`, and the
v214 high-only setup-prime expansion from `288 KiB` to `320 KiB`.
...
`scratch/ps1-perf-iterate/visitor3-high320-low208-v214-broad/20260509-100028-2565654/summary.json`;
...
target speed while cutting VISITOR3 high to `1089/1035` and blocking `83`.
