...
WALKSTUF1 low isolated mid/left/pre-tail/mid-right/pre-left-edge/post-left/late-left2/frame65/post-left-singleton/mid-right-ad/ae/af/frame1/post-mid/frame3/frame140/frame61/frame60/frame62/frame59/frame58/frame63/frame133/frame132/frame5/frame141/frame131/frame19/frame6/frame142/frame130/frame145/frame129 offscreen work-volume clips, the v747/v749/v750/v751/v753/v755/v756/v757/v759/v762/v763 WALKSTUF1 low frame51/frame49/frame47/frame61/frame62/frame58/frame45/frame37/frame35/frame43/frame41 in-place work-volume shrinks, the v760 bounded CD fast-poll recovery, plus the v705 WALKSTUF1 low late-tail subset physical compaction:
...
Latest promoted WALKSTUF1 low work-volume baseline: v747/v749/v750/v751/v753/v755/v756/v757/v759/v762/v763
keep the v726 timing profile exact-flat but shrink frames `51`, `49`, `47`,
`61`, `62`, `58`, `45`, `37`, `35`, `43`, and `41` in-place, preserving every payload offset and
the `1535263` byte pack footprint. Active payload drops `879801 -> 838090`;
entries `51`, `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, and `41` shrink
`5588 -> 770`, `5269 -> 770`, `7399 -> 3158`, `4590 -> 552`, `4599 -> 743`,
`3942 -> 296`, `5276 -> 1657`, `6677 -> 3236`, `6538 -> 3563`, `5555 -> 2211`,
and `5526 -> 2292`; their sector coverage
...
frame39/56/57-style no-shift probes or generated deadline ownership.
