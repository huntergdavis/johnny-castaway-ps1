...
The latest flat size cleanup re-tests `sound_ps1.c -Os` after the
foreground-size phase shift, keeping all VBlank/CD/work metrics unchanged while
preserving sound counters and shrinking the ELF to `723104` bytes.
