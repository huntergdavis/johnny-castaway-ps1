...
120/126 scene/tide variants carry active-loop timing and average `+14.9%` over target /
`88.0%` target speed as of `compact-fgp3-v42-walkstuf1-window32`. The remaining optimization target is therefore
