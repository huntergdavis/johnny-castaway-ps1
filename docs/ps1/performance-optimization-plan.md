...
### VISITOR3 White-Whale Candidate Deck After v192

VISITOR3 is no longer blocked by obvious scalar knobs. The accepted baseline is v189: high `1104/1031`, overrun `73`, blocking `120`, active payload `553878`; low `1108/1028`, overrun `80`, blocking `139`, active payload `595110`. Frame `117` proves byte cuts can hurt cadence, and v187/v192 prove generic runtime narrow upload is too large. The next ideas should either move ownership to generated pack data or change scheduling without expanding `grDrawBackground`.
