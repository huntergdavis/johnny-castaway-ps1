...
ACTIVITY9 low cleanup-metadata compaction, 120/126 scene/tide variants carry
active-loop timing and average `+0.6%` over target / `99.6%` target speed
(`0.6400%` exact over target / `99.6118%` exact target speed). The remaining
...
Checkpoint after `activity9-low-fgp3-cleanup-compact-v081`: the matrix is now
`120` timing-bearing rows at `0.6400%` exact average over target / `99.6118%`
