...
120/126 scene/tide variants carry active-loop timing and average `+12.5%` over target /
`89.5%` target speed as of `stand1-v072-current-refresh` (`12.4923%` exact over target /
`89.4905%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `stand1-v072-current-refresh`: the matrix is now
`120` timing-bearing rows at `12.4923%` exact average over target / `89.4905%`
