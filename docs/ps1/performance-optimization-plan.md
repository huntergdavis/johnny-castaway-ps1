...
`99.5%` target speed as of `mary5-fgp3-padded-v081` (`0.7939%` exact over target /
`99.5149%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `mary5-fgp3-padded-v081`: the matrix is now
`120` timing-bearing rows at `0.7939%` exact average over target / `99.5149%`
