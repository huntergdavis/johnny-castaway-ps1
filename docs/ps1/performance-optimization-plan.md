...
`99.5%` target speed as of `mary2-prefetch-relief-v081` (`0.8228%` exact over target /
`99.4872%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `mary2-prefetch-relief-v081`: the matrix is now
`120` timing-bearing rows at `0.8228%` exact average over target / `99.4872%`
