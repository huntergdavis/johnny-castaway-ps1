...
120/126 scene/tide variants carry active-loop timing and average `+11.9%` over target /
`89.9%` target speed as of `visitor4-v072-current-refresh` (`11.9317%` exact over target /
`89.9171%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `visitor4-v072-current-refresh`: the matrix is now
`120` timing-bearing rows at `11.9317%` exact average over target / `89.9171%`
