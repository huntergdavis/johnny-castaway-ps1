...
120/126 scene/tide variants carry active-loop timing and average `+2.8%` over target /
`97.7%` target speed as of `activity10-johnny3-v072-prefetch-relief` (`2.7833%` exact over target /
`97.6931%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `activity10-johnny3-v072-prefetch-relief`: the matrix is now
`120` timing-bearing rows at `2.7833%` exact average over target / `97.6931%`
exact target speed. The VISITOR3/WALKSTUF1/VISITOR5/ACTIVITY10/JOHNNY3 recoveries prove validation-pack
