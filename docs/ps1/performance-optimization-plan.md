...
`99.5%` target speed as of `activity11-fgp3-padded-v081` (`0.8071%` exact over target /
`99.5018%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `activity11-fgp3-padded-v081`: the matrix is now
`120` timing-bearing rows at `0.8071%` exact average over target / `99.5018%`
