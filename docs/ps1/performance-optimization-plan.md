...
VISITOR3 is no longer blocked by obvious scalar knobs. The accepted baseline is v193: high `1101/1030`, overrun `71`, blocking `116`, active payload `542729`; low remains the v189 pack at `1108/1028`, overrun `80`, blocking `139`, active payload `595110`. Frame `117` proves cleanup geometry matters as much as byte count, v187/v192 prove generic runtime narrow upload is too large, and v196 proves a naive compact motion-marker dispatch is not code-size/cadence safe. The next ideas should either move ownership to generated pack data or change scheduling without expanding `grDrawBackground`.
