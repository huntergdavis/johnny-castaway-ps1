...
`99.4%` target speed as of `activity4-fishing4-v072c-prefetch-relief` (`0.9628%` exact over target /
`99.3677%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `activity4-fishing4-v072c-prefetch-relief`: the matrix is now
`120` timing-bearing rows at `0.9628%` exact average over target / `99.3677%`
