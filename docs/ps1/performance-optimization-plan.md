...
`88.7%` target speed as of `visitor3-v072-prefetch-relief` (`13.7135%` exact over target /
`88.7395%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `visitor3-v072-prefetch-relief`: the matrix is now
`120` timing-bearing rows at `13.7135%` exact average over target / `88.7395%`
