...
120/126 scene/tide variants carry active-loop timing and average `+1.0%` over target /
`99.4%` target speed as of `activity9-fgp3-v072c` (`0.8745%` exact over target /
`99.4479%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `activity9-fgp3-v072c`: the matrix is now
`120` timing-bearing rows at `0.8745%` exact average over target / `99.4479%`
