...
120/126 scene/tide variants carry active-loop timing and average `+1.8%` over target /
`98.6%` target speed as of `mary1-v072c-prefetch-relief` (`1.7731%` exact over target /
`98.6106%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `mary1-v072c-prefetch-relief`: the matrix is now
`120` timing-bearing rows at `1.7731%` exact average over target / `98.6106%`
exact target speed. The VISITOR3/WALKSTUF1/VISITOR5/ACTIVITY10/JOHNNY3/JOHNNY1/ACTIVITY9/MARY1 recoveries prove validation-pack
...
JOHNNY3, STAND4, STAND16, ACTIVITY10, JOHNNY4, FISHING8, STAND6, STAND5, STAND12, BUILDING2, WALKSTUF3, ACTIVITY5, BUILDING5, BUILDING7, VISITOR6, and VISITOR7 row
