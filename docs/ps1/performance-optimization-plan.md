...
`99.4%` target speed as of `activity9-window-v072c` (`0.9493%` exact over target /
`99.3794%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `activity9-window-v072c`: the matrix is now
`120` timing-bearing rows at `0.9493%` exact average over target / `99.3794%`
