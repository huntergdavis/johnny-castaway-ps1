...
BUILDING4 cleanup-metadata/window compaction, 120/126 scene/tide variants carry
active-loop timing and average `+0.6%` over target / `99.6%` target speed
(`0.6452%` exact over target / `99.6067%` exact target speed). The remaining
...
Checkpoint after `building4-fgp3-cleanup-compact-window-v081`: the matrix is now
`120` timing-bearing rows at `0.6452%` exact average over target / `99.6067%`
