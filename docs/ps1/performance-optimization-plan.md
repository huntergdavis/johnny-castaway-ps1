...
| 15 | Closed: frame `116` sparse-hull with upload-cost veto. | v208 tried the stronger no-cleanup hull form after v195 rejected target-hull. It saved `9102` bytes but regressed high `1101/1030 -> 1114/1029` and blocking `106 -> 114`. | Do not retry opcode-1 frame `116` without a new ownership/compression/scheduler model. |
