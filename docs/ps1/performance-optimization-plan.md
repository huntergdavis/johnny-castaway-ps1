...
`88.1%` target speed as of `compact-fgp3-v55-walkstuf1high-derived-prime` (`14.6192%` exact over target /
`88.1128%` exact target speed). The remaining optimization target is therefore
