...
BUILDING2 cleanup-metadata compaction, 120/126 scene/tide variants carry
active-loop timing and average `+0.7%` over target / `99.5%` target speed
(`0.6781%` exact over target / `99.5777%` exact target speed). The remaining
...
Checkpoint after `building2-fgp3-cleanup-compact-v081`: the matrix is now
`120` timing-bearing rows at `0.6781%` exact average over target / `99.5777%`
