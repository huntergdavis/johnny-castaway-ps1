...
| `P5-378` | Failed/no promotion: VISITOR3 tail read groups `315..331` and `333..349`. | After v127, the top matrix rows were high `315..331` and low `333..349`. Unguarded tide-specific source tables reduced loop reads (`27 -> 25`, `31 -> 29`) but regressed visible cadence by four VBlanks on both tides and added one blocking VBlank. Requiring `8` held VBlanks made both tides exact-flat and failed `--require-improvement`. Source was reverted; artifacts are `scratch/ps1-perf-iterate/visitor3-readgroup-315331-333349-v128-focused/20260508-045502-1022084/summary.json` and `scratch/ps1-perf-iterate/visitor3-readgroup-315331-333349-minslack8-v128-focused/20260508-045820-1041906/summary.json`. Close these as standalone hand tables; remaining VISITOR3 read work needs generated scheduler ownership. |
