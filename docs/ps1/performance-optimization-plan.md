...
`99.5%` target speed as of `walkstuf1-fgp2-setup-prime-v080` (`0.8318%` exact over target /
`99.4775%` exact target speed). The remaining optimization target is therefore
...
Checkpoint after `walkstuf1-fgp2-setup-prime-v080`: the matrix is now
`120` timing-bearing rows at `0.8318%` exact average over target / `99.4775%`
