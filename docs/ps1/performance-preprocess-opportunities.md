...
| 3 | `building2` | `high` | 44.91 | 3.05% | 67.28% | 594.54% | 72 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
| 4 | `building4` | `low` | 42.73 | 1.31% | 65.48% | 508.03% | 74 | x-band rect cap pressure; needs selective bands; rect/frame 1.7 |
