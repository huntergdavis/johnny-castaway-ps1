...
- Average measured timing gap: `-0.4559%` over target
...
| 6 | `building2` | `low` | 40.43 | 2.27% | 67.28% | 589.07% | 81 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
