...
- Average measured timing gap: `0.5746%` over target
...
| 2 | `visitor3` | `high` | 295.49 | 37.98% | 56.97% | 303.8% | 300 | x-band rect cap pressure; needs selective bands; rect/frame 1.5 |
