...
- Average measured timing gap: `-0.4637%` over target
...
| 2 | `walkstuf1` | `low` | 47.72 | 3.70% | 45.7% | 671.35% | 94 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
| 3 | `building4` | `low` | 47.04 | 1.42% | 65.1% | 481.57% | 84 | x-band rect cap pressure; needs selective bands; rect/frame 1.7 |
| 4 | `walkstuf1` | `high` | 45.19 | 2.93% | 45.7% | 669.5% | 104 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
| 5 | `building2` | `high` | 44.91 | 3.05% | 67.28% | 589.07% | 72 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
| 6 | `building2` | `low` | 37.01 | 2.20% | 67.28% | 604.44% | 70 | large upload-ready payload; needs compression/selective bands; rect/frame 2.48 |
...
| 9 | `visitor3` | `high` | 30.02 | 2.98% | 55.72% | 943.31% | 51 | x-band rect cap pressure; needs selective bands; rect/frame 1.67 |
| 10 | `mary1` | `low` | 29.84 | 0.41% | 80.45% | 268.49% | 55 | candidate; rect/frame 1.61 |
| 11 | `johnny1` | `low` | 28.69 | 1.49% | 54.11% | 519.48% | 52 | large upload-ready payload; needs compression/selective bands; rect/frame 1.5 |
| 12 | `johnny6` | `low` | 27.86 | 1.00% | 54.86% | 436.4% | 50 | candidate; rect/frame 1.52 |
| 13 | `johnny1` | `high` | 27.65 | 1.44% | 54.11% | 519.48% | 50 | large upload-ready payload; needs compression/selective bands; rect/frame 1.5 |
| 14 | `visitor3` | `low` | 27.52 | 2.59% | 54.7% | 1004.47% | 51 | x-band rect cap pressure; needs selective bands; rect/frame 1.61 |
...
| 17 | `building6` | `low` | 22.48 | 0.77% | 60.41% | 482.98% | 44 | x-band rect cap pressure; needs selective bands; rect/frame 1.63 |
