...
- Average measured timing gap: `-0.4885%` over target
...
| 15 | `walkstuf3` | `low` | 23.2 | 0.65% | 82.98% | 540.22% | 43 | large upload-ready payload; needs compression/selective bands; rect/frame 1.44 |
| 16 | `visitor3` | `low` | 22.66 | 2.12% | 55.26% | 1027.5% | 42 | x-band rect cap pressure; needs selective bands; rect/frame 1.65 |
