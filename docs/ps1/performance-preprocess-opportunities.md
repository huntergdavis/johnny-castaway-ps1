...
- Average measured timing gap: `-0.3629%` over target
...
| 2 | `visitor3` | `high` | 69.88 | 7.08% | 54.64% | 850.4% | 120 | x-band rect cap pressure; needs selective bands; rect/frame 1.59 |
