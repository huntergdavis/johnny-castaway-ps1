...
- Average measured timing gap: `-0.3800%` over target
...
| 2 | `visitor3` | `high` | 60.89 | 6.81% | 54.77% | 993.59% | 88 | x-band rect cap pressure; needs selective bands; rect/frame 1.67 |
