...
- Average measured timing gap: `-0.3966%` over target
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1 | `visitor3` | `high` | 55.3 | 6.14% | 54.77% | 993.59% | 81 | x-band rect cap pressure; needs selective bands; rect/frame 1.67 |
