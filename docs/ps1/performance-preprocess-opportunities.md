...
- Average measured timing gap: `-0.4963%` over target
...
| 4 | `building4` | `low` | 42.73 | 1.31% | 65.48% | 478.89% | 74 | x-band rect cap pressure; needs selective bands; rect/frame 1.7 |
| 5 | `walkstuf1` | `low` | 42.6 | 3.28% | 45.96% | 765.42% | 84 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
