...
- Average measured timing gap: `-0.3755%` over target
...
| 2 | `visitor3` | `high` | 60.38 | 6.49% | 54.3% | 967.84% | 96 | x-band rect cap pressure; needs selective bands; rect/frame 1.64 |
