...
| 2 | `walkstuf1` | `high` | 45.19 | 2.93% | 45.7% | 721.16% | 104 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
| 3 | `building2` | `high` | 44.91 | 3.05% | 67.28% | 591.92% | 72 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
| 4 | `building4` | `low` | 42.73 | 1.31% | 65.48% | 506.67% | 74 | x-band rect cap pressure; needs selective bands; rect/frame 1.7 |
| 5 | `walkstuf1` | `low` | 41.93 | 3.14% | 45.96% | 789.44% | 85 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
