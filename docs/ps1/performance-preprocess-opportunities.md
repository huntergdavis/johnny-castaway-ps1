...
- Average measured timing gap: `0.8556%` over target
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1 | `visitor3` | `low` | 346.51 | 43.58% | 56.97% | 229.28% | 381 | x-band rect cap pressure; needs selective bands; rect/frame 1.5 |
