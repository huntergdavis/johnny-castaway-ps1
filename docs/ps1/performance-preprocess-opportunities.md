...
- Average measured timing gap: `-0.3856%` over target
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1 | `visitor3` | `low` | 69.84 | 6.78% | 55.49% | 754.65% | 124 | x-band rect cap pressure; needs selective bands; rect/frame 1.56 |
