...
- Average measured timing gap: `-0.4511%` over target
...
| 5 | `building2` | `high` | 46.08 | 3.13% | 67.28% | 589.07% | 74 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
