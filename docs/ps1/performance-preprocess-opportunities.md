...
- Average measured timing gap: `0.8850%` over target
...
| 5 | `mary2` | `high` | 215.29 | 3.46% | 61.91% | 543.73% | 668 | large upload-ready payload; needs compression/selective bands; rect/frame 1.55 |
| 6 | `mary2` | `low` | 211.94 | 3.33% | 61.91% | 543.73% | 662 | large upload-ready payload; needs compression/selective bands; rect/frame 1.55 |
| 7 | `building4` | `low` | 207.74 | 7.08% | 65.1% | 191.66% | 318 | x-band rect cap pressure; needs selective bands; rect/frame 1.7 |
| 8 | `building2` | `low` | 207.56 | 14.63% | 67.28% | 258.68% | 327 | candidate; rect/frame 2.47 |
| 9 | `walkstuf1` | `low` | 184.96 | 15.53% | 46.64% | 493.1% | 335 | x-band rect cap pressure; needs selective bands; rect/frame 2.85 |
| 10 | `walkstuf1` | `high` | 171.55 | 13.68% | 46.64% | 493.1% | 328 | x-band rect cap pressure; needs selective bands; rect/frame 2.85 |
| 11 | `johnny2` | `low` | 130.77 | 2.80% | 74.53% | 443.76% | 377 | candidate; rect/frame 1.52 |
| 12 | `johnny2` | `high` | 129.52 | 2.86% | 74.53% | 443.76% | 369 | candidate; rect/frame 1.52 |
| 13 | `building6` | `low` | 68.45 | 3.20% | 44.17% | 810.26% | 136 | x-band rect cap pressure; needs selective bands; rect/frame 2.52 |
| 14 | `building6` | `high` | 65.95 | 3.19% | 44.17% | 810.26% | 126 | x-band rect cap pressure; needs selective bands; rect/frame 2.52 |
| 15 | `walkstuf3` | `high` | 60.93 | 1.89% | 81.22% | 251.74% | 104 | candidate; rect/frame 2.09 |
| 16 | `mary1` | `high` | 50.14 | 0.77% | 78.75% | 274.07% | 84 | candidate; rect/frame 2.33 |
| 17 | `activity9` | `high` | 40.8 | 2.19% | 50.66% | 560.7% | 72 | x-band rect cap pressure; needs selective bands; rect/frame 3.48 |
| 18 | `walkstuf3` | `low` | 35.23 | 1.13% | 77.8% | 581.73% | 60 | large upload-ready payload; needs compression/selective bands; rect/frame 3.21 |
| 19 | `activity9` | `low` | 32.99 | 1.80% | 50.66% | 560.7% | 57 | x-band rect cap pressure; needs selective bands; rect/frame 3.48 |
| 20 | `johnny6` | `high` | 31.56 | 1.14% | 54.86% | 310.08% | 56 | candidate; rect/frame 1.52 |
