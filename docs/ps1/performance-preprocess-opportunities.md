...
- Average measured timing gap: `-0.4226%` over target
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1 | `walkstuf1` | `high` | 61.32 | 4.77% | 45.7% | 668.56% | 121 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
