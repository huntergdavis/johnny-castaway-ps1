...
- Average measured timing gap: `-0.3934%` over target
...
|---:|---|---|---:|---:|---:|---:|---:|---|
| 1 | `visitor3` | `low` | 60.35 | 5.80% | 55.58% | 798.09% | 108 | x-band rect cap pressure; needs selective bands; rect/frame 1.58 |
