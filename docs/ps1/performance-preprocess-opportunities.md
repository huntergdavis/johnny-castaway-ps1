...
- Average measured timing gap: `12.4923%` over target
...
| 9 | `visitor5` | `high` | 172.08 | 17.64% | 75.3% | 584.49% | 113 | large upload-ready payload; needs compression/selective bands |
| 10 | `activity9` | `high` | 169.48 | 10.36% | 63.79% | 584.63% | 137 | large upload-ready payload; needs compression/selective bands |
| 11 | `walkstuf3` | `low` | 166.81 | 7.92% | 77.8% | 581.73% | 104 | large upload-ready payload; needs compression/selective bands |
| 12 | `mary1` | `high` | 162.42 | 3.69% | 78.75% | 274.07% | 89 | candidate |
| 13 | `building7` | `high` | 155.28 | 4.77% | 79.16% | 319.45% | 67 | candidate |
| 14 | `building4` | `high` | 153.03 | 4.87% | 65.1% | 191.66% | 258 | candidate |
| 15 | `building5` | `high` | 141.9 | 5.04% | 73.0% | 558.04% | 77 | large upload-ready payload; needs compression/selective bands |
| 16 | `mary1` | `low` | 136.19 | 3.20% | 80.45% | 268.49% | 46 | candidate |
| 17 | `visitor5` | `low` | 133.22 | 14.34% | 75.3% | 584.49% | 63 | large upload-ready payload; needs compression/selective bands |
| 18 | `activity5` | `high` | 131.7 | 9.37% | 76.53% | 677.37% | 37 | large upload-ready payload; needs compression/selective bands |
| 19 | `building4` | `low` | 129.83 | 4.58% | 65.1% | 191.66% | 186 | candidate |
| 20 | `visitor6` | `high` | 128.36 | 7.49% | 79.65% | 832.92% | 26 | large upload-ready payload; needs compression/selective bands |
