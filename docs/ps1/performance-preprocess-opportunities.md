...
- Average measured timing gap: `-0.4366%` over target
...
| 3 | `building2` | `high` | 41.57 | 2.89% | 67.28% | 594.62% | 64 | large upload-ready payload; needs compression/selective bands; rect/frame 2.47 |
| 4 | `visitor3` | `low` | 40.59 | 3.37% | 55.26% | 1027.5% | 85 | x-band rect cap pressure; needs selective bands; rect/frame 1.65 |
