...
- Average measured timing gap: `-0.4819%` over target
...
| 14 | `visitor3` | `high` | 24.5 | 2.50% | 54.83% | 986.39% | 41 | x-band rect cap pressure; needs selective bands; rect/frame 1.67 |
