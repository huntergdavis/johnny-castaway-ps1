...
- Average measured timing gap: `-0.4968%` over target
...
| 5 | `walkstuf1` | `low` | 42.14 | 3.21% | 45.96% | 780.79% | 84 | x-band rect cap pressure; needs selective bands; rect/frame 2.41 |
