...
- Candidate rows: `20986`
- Standalone probes: `102`
- Scheduler or guarded probes: `533`
- Scheduler-owned only: `7322`
- Closed exact ranges from experiment log: `5107`
- Deferred under-target rows: `1762`
