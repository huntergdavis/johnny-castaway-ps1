...
| 3 | `visitor3` | `high` | 1071/1045 | 35 | `40..52` (12s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 4 | `visitor3` | `high` | 1071/1045 | 35 | `40..56` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 5 | `visitor3` | `high` | 1071/1045 | 35 | `40..64` (24s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 6 | `visitor3` | `high` | 1071/1045 | 35 | `40..46` (6s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 7 | `visitor3` | `high` | 1071/1045 | 35 | `44..50` (6s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
...
| 23 | `walkstuf1` | `high` | 1471/1440 | 56 | `74..98` (24s) | 3 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 24 | `walkstuf1` | `high` | 1471/1440 | 56 | `80..92` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 25 | `walkstuf1` | `high` | 1471/1440 | 56 | `360..376` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 26 | `walkstuf1` | `high` | 1471/1440 | 56 | `92..108` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 27 | `walkstuf1` | `high` | 1471/1440 | 56 | `357..369` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 28 | `walkstuf1` | `high` | 1471/1440 | 56 | `84..100` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
