...
| 6 | `building2` | `low` | 1336/1316 | 48 | `153..177` (24s) | 4 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 7 | `building2` | `low` | 1336/1316 | 48 | `145..169` (24s) | 4 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 8 | `building2` | `low` | 1336/1316 | 48 | `137..161` (24s) | 4 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 9 | `building2` | `low` | 1336/1316 | 48 | `245..261` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 10 | `building2` | `low` | 1336/1316 | 48 | `252..264` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 11 | `building2` | `low` | 1336/1316 | 48 | `258..270` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 12 | `building2` | `low` | 1336/1316 | 48 | `133..145` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 13 | `building2` | `low` | 1336/1316 | 48 | `258..264` (6s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 14 | `walkstuf1` | `high` | 1475/1441 | 57 | `84..108` (24s) | 4 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 15 | `walkstuf1` | `high` | 1475/1441 | 57 | `165..189` (24s) | 3 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 16 | `walkstuf1` | `high` | 1475/1441 | 57 | `74..98` (24s) | 3 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 17 | `walkstuf1` | `high` | 1475/1441 | 57 | `171..195` (24s) | 3 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 18 | `walkstuf1` | `high` | 1475/1441 | 57 | `178..194` (16s) | 2 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 19 | `walkstuf1` | `high` | 1475/1441 | 57 | `351..367` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 20 | `walkstuf1` | `high` | 1475/1441 | 57 | `99..115` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 21 | `walkstuf1` | `high` | 1475/1441 | 57 | `360..376` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 22 | `walkstuf1` | `high` | 1475/1441 | 57 | `80..92` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 23 | `walkstuf1` | `high` | 1475/1441 | 57 | `357..369` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 24 | `walkstuf1` | `high` | 1475/1441 | 57 | `268..280` (12s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 25 | `walkstuf1` | `high` | 1475/1441 | 57 | `171..183` (12s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
...
| 38 | `building4` | `low` | 2849/2816 | 38 | `178..202` (24s) | 1 | `balanced:medium-visible-gap` | `closed-by-experiment-log` |
| 39 | `building4` | `low` | 2849/2816 | 38 | `262..286` (24s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 40 | `building4` | `low` | 2849/2816 | 38 | `274..298` (24s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
