...
- Closed exact ranges from experiment log: `26`
...
| 24 | `visitor3` | `low` | 1065/1039 | 75 | `240..256` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 25 | `visitor3` | `low` | 1065/1039 | 75 | `239..251` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 26 | `visitor3` | `low` | 1065/1039 | 75 | `248..260` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 27 | `visitor3` | `low` | 1065/1039 | 75 | `239..255` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 28 | `visitor3` | `low` | 1065/1039 | 75 | `240..252` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
...
| 38 | `walkstuf1` | `high` | 1475/1441 | 59 | `84..108` (24s) | 4 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 39 | `walkstuf1` | `high` | 1475/1441 | 59 | `164..188` (24s) | 3 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 40 | `walkstuf1` | `high` | 1475/1441 | 59 | `156..180` (24s) | 3 | `risky:short-visible-gap` | `closed-by-experiment-log` |
