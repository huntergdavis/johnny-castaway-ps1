...
| 12 | `visitor3` | `low` | 1405/1015 | 301 | `99..115` (16s) | 5 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 13 | `visitor3` | `low` | 1405/1015 | 301 | `106..122` (16s) | 4 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 14 | `visitor3` | `low` | 1405/1015 | 301 | `99..111` (12s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 15 | `visitor3` | `low` | 1405/1015 | 301 | `106..118` (12s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 16 | `visitor3` | `low` | 1405/1015 | 301 | `108..114` (6s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 17 | `visitor3` | `low` | 1405/1015 | 301 | `105..111` (6s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 18 | `visitor3` | `low` | 1405/1015 | 301 | `106..112` (6s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 19 | `visitor3` | `low` | 1405/1015 | 301 | `110..116` (6s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 20 | `visitor3` | `high` | 1406/1019 | 293 | `124..140` (16s) | 1 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 21 | `visitor3` | `high` | 1406/1019 | 293 | `111..127` (16s) | 1 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 22 | `building4` | `high` | 2939/2786 | 240 | `531..547` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 23 | `building4` | `high` | 2939/2786 | 240 | `547..563` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
