...
- Source artifact root: `scratch/ps1-perf-iterate/building2-restore-minus-current-v108-highonly-broad/20260508-010735-3907687`
- Candidate rows: `71`
- Standalone probes: `0`
...
|---:|---|---|---:|---:|---|---:|---|---|
| 1 | `building2` | `high` | 1353/1311 | 56 | `60..72` (12s) | 1 | `balanced:medium-visible-gap` | `scheduler-or-guarded-probe` |
| 2 | `building2` | `low` | 1385/1303 | 121 | `365..381` (16s) | 2 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 3 | `building2` | `low` | 1385/1303 | 121 | `204..220` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 4 | `building2` | `low` | 1385/1303 | 121 | `371..387` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 5 | `building2` | `low` | 1385/1303 | 121 | `377..393` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 6 | `building2` | `low` | 1385/1303 | 121 | `284..296` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 7 | `building2` | `low` | 1385/1303 | 121 | `74..86` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 8 | `building2` | `low` | 1385/1303 | 121 | `204..216` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 9 | `building2` | `high` | 1353/1311 | 56 | `226..242` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 10 | `building2` | `high` | 1353/1311 | 56 | `222..238` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 11 | `building2` | `high` | 1353/1311 | 56 | `206..222` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 12 | `building2` | `high` | 1353/1311 | 56 | `214..230` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 13 | `building2` | `high` | 1353/1311 | 56 | `226..238` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 14 | `building2` | `high` | 1353/1311 | 56 | `222..234` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 15 | `building2` | `high` | 1353/1311 | 56 | `185..197` (12s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
