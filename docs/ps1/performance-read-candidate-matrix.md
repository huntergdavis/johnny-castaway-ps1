...
|---:|---|---|---:|---:|---|---:|---|---|
| 1 | `walkstuf1` | `high` | 1472/1441 | 43 | `92..116` (24s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 2 | `walkstuf1` | `high` | 1472/1441 | 43 | `411..423` (12s) | 1 | `risky:short-visible-gap` | `scheduler-owned-only` |
