...
- Source artifact root: `scratch/ps1-perf-iterate/walkstuf1-low-trim-entry39-canaries-flat-ok/20260520-024749-2458159`
- Candidate rows: `52`
- Standalone probes: `0`
...
|---:|---|---|---:|---:|---|---:|---|---|
| 1 | `walkstuf1` | `high` | 1471/1440 | 56 | `345..361` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
...
| 14 | `walkstuf1` | `high` | 1471/1440 | 56 | `352..376` (24s) | 4 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 15 | `walkstuf1` | `high` | 1471/1440 | 56 | `84..108` (24s) | 4 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 16 | `walkstuf1` | `high` | 1471/1440 | 56 | `345..369` (24s) | 4 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 17 | `walkstuf1` | `high` | 1471/1440 | 56 | `74..98` (24s) | 3 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 18 | `walkstuf1` | `high` | 1471/1440 | 56 | `80..92` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 19 | `walkstuf1` | `high` | 1471/1440 | 56 | `360..376` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 20 | `walkstuf1` | `high` | 1471/1440 | 56 | `92..108` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 21 | `walkstuf1` | `high` | 1471/1440 | 56 | `352..368` (16s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
| 22 | `walkstuf1` | `high` | 1471/1440 | 56 | `357..369` (12s) | 2 | `unsafe:tight-visible-gap` | `closed-by-experiment-log` |
