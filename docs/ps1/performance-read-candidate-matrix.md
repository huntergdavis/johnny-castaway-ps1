...
|---:|---|---|---:|---:|---|---:|---|---|
| 1 | `building2` | `high` | 1394/1301 | 138 | `371..383` (12s) | 1 | `balanced:validate-overlap` | `scheduler-or-guarded-probe` |
| 2 | `building2` | `low` | 1385/1303 | 121 | `371..383` (12s) | 1 | `balanced:validate-overlap` | `scheduler-or-guarded-probe` |
| 3 | `activity9` | `low` | 2085/2058 | 29 | `229..245` (16s) | 1 | `balanced:medium-visible-gap` | `scheduler-or-guarded-probe` |
| 4 | `building2` | `high` | 1394/1301 | 138 | `11..27` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 5 | `building2` | `high` | 1394/1301 | 138 | `24..36` (12s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 6 | `building2` | `high` | 1394/1301 | 138 | `18..30` (12s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 7 | `building2` | `high` | 1394/1301 | 138 | `18..34` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 8 | `building2` | `high` | 1394/1301 | 138 | `24..40` (16s) | 3 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 9 | `building2` | `high` | 1394/1301 | 138 | `365..381` (16s) | 2 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 10 | `building2` | `high` | 1394/1301 | 138 | `24..30` (6s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 11 | `building2` | `high` | 1394/1301 | 138 | `72..84` (12s) | 1 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 12 | `building2` | `high` | 1394/1301 | 138 | `25..31` (6s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 13 | `building2` | `low` | 1385/1303 | 121 | `365..381` (16s) | 2 | `risky:short-visible-gap` | `scheduler-owned-only` |
| 14 | `building2` | `low` | 1385/1303 | 121 | `204..220` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 15 | `building2` | `low` | 1385/1303 | 121 | `371..387` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 16 | `building2` | `low` | 1385/1303 | 121 | `377..393` (16s) | 2 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 17 | `building2` | `low` | 1385/1303 | 121 | `284..296` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 18 | `building2` | `low` | 1385/1303 | 121 | `187..199` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
| 19 | `building2` | `low` | 1385/1303 | 121 | `74..86` (12s) | 1 | `unsafe:tight-visible-gap` | `scheduler-owned-only` |
...
| 27 | `visitor3` | `low` | 1361/1023 | 250 | `97..113` (16s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 28 | `visitor3` | `low` | 1361/1023 | 250 | `111..123` (12s) | 1 | `balanced:validate-overlap` | `closed-by-experiment-log` |
| 29 | `visitor3` | `low` | 1361/1023 | 250 | `111..127` (16s) | 1 | `balanced:validate-overlap` | `closed-by-experiment-log` |
| 30 | `visitor3` | `low` | 1361/1023 | 250 | `104..120` (16s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 31 | `visitor3` | `high` | 1357/1023 | 246 | `97..113` (16s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
| 32 | `visitor3` | `high` | 1357/1023 | 246 | `111..123` (12s) | 1 | `balanced:validate-overlap` | `closed-by-experiment-log` |
| 33 | `visitor3` | `high` | 1357/1023 | 246 | `111..127` (16s) | 1 | `balanced:validate-overlap` | `closed-by-experiment-log` |
| 34 | `visitor3` | `high` | 1357/1023 | 246 | `104..120` (16s) | 1 | `risky:short-visible-gap` | `closed-by-experiment-log` |
