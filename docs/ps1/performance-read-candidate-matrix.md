...
- Candidate rows: `18484`
- Standalone probes: `100`
- Scheduler or guarded probes: `499`
- Scheduler-owned only: `7029`
- Closed exact ranges from experiment log: `3409`
- Deferred under-target rows: `1690`
