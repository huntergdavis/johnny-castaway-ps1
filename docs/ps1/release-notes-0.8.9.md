...
mainline performance work through `walkstuf1-low-frame133-inplace-v773`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, `32`, and `133` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame133-inplace-v773-workreduction/20260514-120442-639343/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T12:04:42` with stats
  version `walkstuf1-low-frame133-inplace-v773`.
