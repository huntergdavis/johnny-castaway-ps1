...
mainline performance work through `walkstuf1-low-frame5-inplace-v774`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, `32`, `133`, and `5` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame5-inplace-v774-workreduction/20260514-121115-676249/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T12:11:15` with stats
  version `walkstuf1-low-frame5-inplace-v774`.
