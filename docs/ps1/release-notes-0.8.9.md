...
mainline performance work through `walkstuf1-low-frame69-inplace-v771`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, and `69` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame69-inplace-v771-workreduction/20260514-115022-558481/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T11:50:22` with stats
  version `walkstuf1-low-frame69-inplace-v771`.
