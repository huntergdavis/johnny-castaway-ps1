...
mainline performance work through `walkstuf1-low-frame28-inplace-v787`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, `32`, `133`, `5`, `141`, `70`, `30`, `6`, `71`, `72`, `142`, `73`, `131`, `74`, `19`, and `28` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame28-inplace-v787-workreduction/20260514-143028-1451481/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T14:30:28` with stats
  version `walkstuf1-low-frame28-inplace-v787`.
