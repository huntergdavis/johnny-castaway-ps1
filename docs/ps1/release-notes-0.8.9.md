...
BOOTMODE/Scene Explorer stability fixes from v0.8.7, and promotes the current
  mainline performance work through `walkstuf1-low-frame68-inplace-v770`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, and `68` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame68-inplace-v770-workreduction/20260514-110926-321456/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T11:09:26` with stats
  version `walkstuf1-low-frame68-inplace-v770`.
