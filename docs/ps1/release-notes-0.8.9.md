...
mainline performance work through `walkstuf1-low-frame32-inplace-v772`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, and `32` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame32-inplace-v772-workreduction/20260514-115748-600413/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T11:57:48` with stats
  version `walkstuf1-low-frame32-inplace-v772`.
