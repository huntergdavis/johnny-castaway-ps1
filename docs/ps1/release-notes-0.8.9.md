...
mainline performance work through `walkstuf1-low-frame30-inplace-v777`.
...
- **WALKSTUF1 low carries the newest no-shift pack baseline.** Frames `51`,
  `49`, `47`, `61`, `62`, `58`, `45`, `37`, `35`, `43`, `41`, `57`, `33`, `67`, `68`, `69`, `32`, `133`, `5`, `141`, `70`, and `30` now shrink in-place while
...
- Latest focused gate:
  `scratch/ps1-perf-iterate/walkstuf1-low-frame30-inplace-v777-workreduction/20260514-124737-879499/summary.json`.
- Latest matrix row:
  `docs/ps1/performance-scene-matrix.csv` at `2026-05-14T12:47:37` with stats
  version `walkstuf1-low-frame30-inplace-v777`.
