...
SCREENS: tuple[ScreenDoc, ...] = (
    ScreenDoc(
        ...
        "Pause Menu",
        "Start",
        "The top-level dispatch screen: resume, enter or exit Freeplay, open Freeplay Options, World Options, Accessibility, or System.",
    ...
    ScreenDoc(
        "accessibility",
        "Accessibility",
        "Start, Down, Down, Down, Down, Cross",
