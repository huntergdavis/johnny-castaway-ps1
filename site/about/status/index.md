...
latest VISITOR3 pass moves high to `1089/1035`, moves low to `1098/1034`,
cuts high blocking `114 -> 83` and low blocking `139 -> 112`, and trades
setup time for lower active-loop CD pressure through high/low persistent
segments, high-only re-anchor payloads, and the guarded low second setup
segment. The
...
- **Optimization after full validation.** With all 63 scenes signed off, the
  ...
  plus high-only re-anchor passes.
