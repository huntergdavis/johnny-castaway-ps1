...
loop reads/read time to `60/272` and due misses to `11`, and v747/v749/v750/v751/v753/v755/v756/v757/v759/v762
also shrinking low frames `51`/`49`/`47`/`61`/`62`/`58`/`45`/`37`/`35`/`43` in-place to `841324` active payload after the release merge. Both drop
