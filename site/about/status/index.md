...
allocation. The public headless battle card is `+0.1906%` over
target / `99.8111%` target speed; the raw signed optimization matrix is
`-0.5263%` / `100.5414%`. The allocator validation branch records a R34
