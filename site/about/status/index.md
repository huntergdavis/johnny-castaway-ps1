...
and keeps `1478/1431`, blocking/refill `64/20`, reads/due `62/11`, with v747/v749/v750/v751
also shrinking low frames `51`/`49`/`47`/`61` in-place to `862205` active payload. Both drop
