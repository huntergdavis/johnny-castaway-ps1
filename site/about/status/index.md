...
allocation. The public headless battle card is `+0.2155%` over
target / `99.7870%` target speed; the raw signed optimization matrix is
about `-0.5014%` / `100.5173%`. The allocator validation branch records a R34
