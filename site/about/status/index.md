...
allocation. The public headless battle card is `+0.1956%` over
target / `99.8062%` target speed; the raw signed optimization matrix is
`-0.5213%` / `100.5366%`. The allocator validation branch records a R34
