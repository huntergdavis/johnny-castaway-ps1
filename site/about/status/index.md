...
allocation. The public headless battle card is `+0.1977%` over
target / `99.8041%` target speed; the raw signed optimization matrix is
`-0.5192%` / `100.5344%`. The allocator validation branch records a R34
