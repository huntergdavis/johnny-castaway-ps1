...
scripted controller-input harness, so the documentation doubles as a
regression test for Start, D-pad navigation, Cross selection, Circle back,
and the major menu states.
