...
the public average is **+0.2% over target / 99.8% target speed** (`0.1762%`
exact public over target / `99.8252%` exact public target speed); the raw
signed optimization matrix is `-0.5407%` / `100.5555%`.
...
- **Timing compression before throughput work.** The timing-bearing matrix
  public average is now +0.1762% over target / 99.8252% target speed, with three
