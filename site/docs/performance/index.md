...
the public average is **+0.3% over target / 99.7% target speed** (`0.3326%`
exact public over target / `99.6742%` exact public target speed); the raw
signed optimization matrix is `-0.4344%` / `100.4566%`.
...
- **Timing compression before throughput work.** The timing-bearing matrix
  public average is now +0.3326% over target / 99.6742% target speed, with several
