...
the public average is **+0.3% over target / 99.7% target speed** (`0.3273%`
exact public over target / `99.6792%` exact public target speed); the raw
signed optimization matrix is `-0.4397%` / `100.4616%`.
...
- **Timing compression before throughput work.** The timing-bearing matrix
  public average is now +0.3273% over target / 99.6792% target speed, with several
