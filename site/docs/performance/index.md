...
the public average is **+0.3% over target / 99.7% target speed** (`0.3253%`
exact public over target / `99.6811%` exact public target speed); the raw
signed optimization matrix is `-0.4432%` / `100.4649%`.
...
window. The latest matrix run is `2026-05-10T02:50:49`; per-row freshness and stats version are shown on
...
rows now use `visitor3-low-alias-noop114117-v292`,
`visitor3-high-f140-segment-copy-v291`,
`visitor3-low-noop113-v249`,
`visitor3-low-noop114117-v248`,
`visitor3-high-f127-f130-resident-copy-v238`,
...
- **Timing compression before throughput work.** The timing-bearing matrix
  public average is now +0.3253% over target / 99.6811% target speed, with several
