...
measured battle-card rows, the average is **+13.1% over target / 88.9%
target speed**.

## Scene Battle Card

As of 2026-04-29, 78 of 126 scene/tide variants have current headless
perf measurements. 48 of 63 scenes have at least one timed variant; 30
scenes have both high- and low-tide variants timed. The latest matrix
run is `2026-04-29T14:56:28`; per-row freshness is shown on the
