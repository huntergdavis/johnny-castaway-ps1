...
the public average is **+0.3% over target / 99.8% target speed** (`0.2474%`
exact public over target / `99.7563%` exact public target speed); the raw
signed optimization matrix is about `-0.4695%` / `100.4867%`.
...
the later frame135 gap-D4 data-shape pass, and the newest `16..32` retained
read group. The current canonical row is `1066/1035`, overrun `31`,
blocking/read/due `73/17/13`, without hidden prefetch debt.
...
- **Timing compression before throughput work.** The timing-bearing matrix
  public average is now +0.2474% over target / 99.7563% target speed, with several
