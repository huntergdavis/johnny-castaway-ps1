...
same no-shift payload lane through `walkstuf1-low-frame94-inplace-v865`.
...
`879801 -> 791764` without moving pack offsets, LBA/sectors, or PS-EXE size.
...
5. **Generated scheduler ownership for the remaining under-99 rows.** MARY3 is
   ...
   through frame `94` in-place (`879801 -> 791764` active payload), and v760
