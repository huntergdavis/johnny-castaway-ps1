...
5. Read the per-scene page for [FISHING 1]({{ '/scenes/fishing1/' | relative_url }}).
6. Read the [regtest docs]({{ '/docs/regtest/' | relative_url }}) and understand why "it looked fine once" does not count.
