...
scene booting plus Scene Explorer preview loading, [`v0.8.8`]({{ '/releases/#v088-ps1--visitor5-high-retained-read-promotion' | relative_url }}) promotes VISITOR5 high into green, [`v0.8.9`]({{ '/releases/#v089-ps1--walkstuf1-low-in-place-payload-reductions' | relative_url }}) promotes VISITOR5 low plus the first W1-low in-place payload lane, and [`v0.8.10`]({{ '/releases/#v0810-ps1--walkstuf1-low-no-shift-payload-follow-through' | relative_url }}) carries that no-shift WALKSTUF1 low baseline through frame `76` with active payload `879801 -> 801103` — the public battle card now averages
