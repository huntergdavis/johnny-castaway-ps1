...
scene booting plus Scene Explorer preview loading, [`v0.8.8`]({{ '/releases/#v088-ps1--visitor5-high-retained-read-promotion' | relative_url }}) promotes VISITOR5 high into green, and current mainline promotes VISITOR5 low, a same-speed WALKSTUF1 low CD-work cleanup, the BUILDING2 low `218..229` slack-8 row, VISITOR3 high tail repacking, and BUILDING4 low offscreen draw-span clipping — the public battle card now averages
