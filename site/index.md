...
scene booting plus Scene Explorer preview loading, [`v0.8.8`]({{ '/releases/#v088-ps1--visitor5-high-retained-read-promotion' | relative_url }}) promotes VISITOR5 high into green, and [`v0.8.9`]({{ '/releases/#v089-ps1--walkstuf1-low-in-place-payload-reductions' | relative_url }}) promotes VISITOR5 low, same-speed WALKSTUF1 CD-work and high/low late-tail work-volume cleanups, the BUILDING2 low `218..229` slack-8 row plus v739 draw-tail trimming, VISITOR3 high tail repacking, BUILDING4 low offscreen draw-span clipping, and WALKSTUF1 low frame `51`/`49`/`47`/`61`/`62`/`58`/`45`/`37`/`35` in-place shrinks — the public battle card now averages
