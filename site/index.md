...
scene booting plus Scene Explorer preview loading, [`v0.8.8`]({{ '/releases/#v088-ps1--visitor5-high-retained-read-promotion' | relative_url }}) promotes VISITOR5 high into green, and current mainline promotes VISITOR5 low plus a same-speed WALKSTUF1 low CD-work cleanup, with the latest WALKSTUF1 and BUILDING2 low closure logs marked inert or phase-negative — the public battle card now averages
