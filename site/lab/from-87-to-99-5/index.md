...
**+0.3202% over target / 99.6880% target speed**, with roughly **17.08
...
plus high terminal-trim promotions moved both VISITOR3 tides out of red while
keeping the allocator-safe CACHE budget intact.
