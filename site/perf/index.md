...
| Stats version | mixed across rows; latest refreshed row is `building2-high-frame169-inplace-v896`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
