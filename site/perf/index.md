...
Latest promoted BUILDING2 note: `building2-high-frame90-offscreen-v702`
adds frame `90` on top of the safe high-tide offscreen clips for frames `91`,
`92`, `94..104`, and `168..177`, staying exact-flat at `1602`, `1351/1311`,
blocking/refill `54/18`, and reads/due `58/7` while dropping runtime frame
rows/spans/pixels `18144/110717/468636 -> 18049/106656/450462`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame63-offscreen-v696`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-14T02:22:05</td>
      <td>building2-high-frame90-offscreen-v702</td>
      <td>+3.0%</td>
      ...
      <td>18</td>
      <td>7</td>
      <td>same-speed BUILDING2 high offscreen draw-span clipping adds frame 90 on top of the v701 frame 91, v700 frame 92, v698 safe 94..104, and v664 late 168..177 clips; removes another 3749 offscreen draw pixels, 921 spans, and 20 draw/frame rows, and drops runtime frame rows/spans/pixels 18069/107577/454211 -&gt; 18049/106656/450462 while preserving scene/loop/target 1602/1351/1311, overrun 40, blocking/refill 54/18, reads/due 58/7, pack LBA/sectors, and PS-EXE bucket</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T01:41:07</td>
      <td>walkstuf1-low-frame63-offscreen-v696</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed frame63 offscreen draw-span clipping on top of v695 changes 1 entry, removes 3983 draw pixels, 578 spans, and 30 draw rows, and drops runtime frame rows/spans/pixels 16302/117490/654606 -&gt; 16272/116912/650623 while preserving scene/loop/target 1770/1478/1431, overrun 47, blocking/refill 64/20, reads/due 62/11, pack LBA/sectors, and PS-EXE bucket</td>
    </tr>
