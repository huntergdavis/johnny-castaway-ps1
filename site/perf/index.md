...
| Stats version | mixed across rows; latest refreshed row is `building4-low-frame41-inplace-v903`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
