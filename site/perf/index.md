...
`w1high-clip35-41-headroom` clips active-loop `WALKSTUF1.FG2` entries `35`,
`37`, `39`, and `41` on top of the earlier entries `0`, `1`, `3`, `5`, `6`,
`8`, `10`, `11`, `12`, `19`, `21`, and `22` offscreen clip and the entry
`58..61` tail/phase speed promotion. It preserves the `1535263` byte pack
footprint, LBA `24891`, sectors `750`, table entry sizes, and the `233472` byte
PS-EXE bucket. The latest subset drops selected logical payload `26856 ->
23537`, removing `688` cleanup pixels and `4706` draw pixels. W1-high timing
...
rows/spans/pixels `16712/127281/714231 -> 16641/124649/688006`. BUILDING2 high
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-22T15:49:45</td>
      <td>w1high-clip35-41-headroom</td>
      <td>2.0%</td>
