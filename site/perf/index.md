...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame129-offscreen-v726`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-14T05:51:38</td>
      <td>walkstuf1-high-frame138-offscreen-v732</td>
      <td>+2.9%</td>
      ...
      <td>23</td>
      <td>16</td>
      <td>same-speed frame138 offscreen draw-span clip on top of v731 preserves file size, pack LBA/sectors, PS-EXE bucket, scene/loop/target 1764/1476/1434, overrun 42, blocking/refill 81/23, reads/due 63/16, and active payload 882007 while dropping runtime rows/spans/pixels 17235/134039/768120 -&gt; 17235/134035/766315; v731 already clipped frame55 and v657 still provides late-tail physical compaction and loop reads/read time 65/282 -&gt; 63/275</td>
    </tr>
    <tr id="perf-walkstuf1-low">
      <td><a class="scene-perf-rowlink" href="#perf-walkstuf1-low"><code>walkstuf1</code></a></td>
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T04:44:56</td>
      <td>walkstuf1-low-frame129-offscreen-v726</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed frame 129 offscreen draw-span clip on top of v725 preserves file size, pack LBA/sectors, PS-EXE bucket, scene/loop/target 1770/1478/1431, overrun 47, blocking/refill 64/20, reads/read time 60/274, and due 11 while trimming 782 draw pixels and 56 spans; v725/v724/v723/v722/v721/v720/v719/v718/v717/v716 still provide the frame 145/130/142/6/19/131/141/5/132/133 work cuts and v705 still provides the late-tail active-payload cut 916139 -&gt; 879801 plus loop reads/read VBlanks 62/281 -&gt; 60/274 on the clean current baseline</td>
    </tr>
