...
v183-v196 probes close low precursor motion-copy frames `114..118`, the C-side
...
generic narrow dirty-row upload plus naive compact-v4 motion-marker dispatch; the remaining
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-visitor3-low">
      ...
      <td>0</td>
      <td>25</td>
      <td>v197 code-headroom row; low pack remains exact-flat after unused noncompact motion dispatch removal with fixed offsets LBA and PS-EXE bucket</td>
    </tr>
