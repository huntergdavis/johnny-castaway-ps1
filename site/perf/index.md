...
| Stats version | mixed across rows; latest refreshed row is `walkstuf1-low-frame98-inplace-v861`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
| FISHING 1 canary | `1068 / 1072 VBlanks`, `0.0%` public over target, `100.0%` public target speed, `blocking_vb=5` |

Current W1 payload/speed track: `walkstuf1-low-frame98-inplace-v861`
shrinks low entry `98` / source frame `183` in place after the v860 frame89
trim, preserving all payload offsets while cutting that entry `4985 -> 4779`
...
v860/v861 frame89/frame98 trims keep those metrics exact-flat while reducing payload.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame98-inplace-v861`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T23:31:17</td>
      <td>walkstuf1-low-frame98-inplace-v861</td>
      <td>+3.1%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed fixed-sector frame98 payload shrink on top of v860; entry 98/source frame 183 shrinks 4985 -&gt; 4779 bytes, active payload 792657 -&gt; 792451, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1769/1477/1432, overrun 45, blocking/refill 65/20, reads/read time 58/259, and due 11.</td>
    </tr>
