...
`walkstuf1-low-frame61-inplace-v751` then shrink frames `51`, `49`, `47`, and
`61` in-place without moving offsets, keeping timing exact-flat while active
payload drops `879801 -> 862205`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame61-inplace-v751`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:27:55</td>
      <td>walkstuf1-low-frame61-inplace-v751</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame61 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 866243-&gt;862205 and entry sectors 3-&gt;1</td>
    </tr>
