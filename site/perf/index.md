...
Current battle-card rollup as of <time datetime="2026-05-15">2026-05-15</time>:
...
| Stats version | mixed across rows; latest refreshed row is `building4-low-frame426-inplace-v895`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
shrinks low entry `107` / source frame `214` in place after the v875 frame109
trim, preserving all payload offsets while cutting that entry `1959 -> 1900`
...
Current B2-high payload track: `building2-high-frame168-inplace-v892` trims
entry `168` / source frame `219` after v877/v879/v880/v887/v888/v889/v890/v891 trimmed entries
`172`, `171`, `96`, `170`, `97`, `98`, `174`, and `99`, preserving offsets, pack LBA/sectors, and the PS-EXE bucket while cutting
active payload `674798 -> 670444`. Timing/CD stay exact-flat at `1602`,
...
Latest promoted BUILDING2 note: `building2-high-frame168-inplace-v892`
trims entry `168` / source frame `219` after v877/v879/v880/v887/v888/v889/v890/v891 trimmed entries
`172`, `171`, `96`, `170`, `97`, `98`, `174`, and `99` and the v703 high-tide offscreen clip stack for frames `89..92`,
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building4-low-frame426-inplace-v895`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-15T04:00:26</td>
      <td>building2-high-frame168-inplace-v892</td>
      <td>+3.0%</td>
      ...
      <td>18</td>
      <td>7</td>
      <td>same-speed preserve-offset frame168 payload shrink on top of v891; entry 168/source frame 219 shrinks 1372 -&gt; 1266 bytes, active payload 670550 -&gt; 670444, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1602/1351/1311, overrun 40, blocking/refill 54/18, reads/read time 58/257, and due 7</td>
    </tr>
    ...
    <tr id="perf-building4-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T04:25:14</td>
      <td>building4-low-frame426-inplace-v895</td>
      <td>+1.3%</td>
      ...
      <td>34</td>
      <td>1</td>
      <td>same-speed frame426 in-place entry-size shrink preserves offsets/LBA/EXE bucket on top of v893 while cutting active payload 809792-&gt;809364; frame426/source621 shrinks 616-&gt;188, entry sectors 1-&gt;1, scene/loop/target stay 3128/2853/2816, overrun 37, blocking/refill 40/34, read VBlanks 215, due 1</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T01:39:26</td>
      <td>walkstuf1-low-frame107-inplace-v876</td>
      <td>+3.1%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed fixed-sector frame107 payload shrink on top of v875; entry 107/source frame 214 shrinks 1959 -&gt; 1900 bytes, active payload 790381 -&gt; 790322, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1769/1477/1432, overrun 45, blocking/refill 65/20, reads/read time 58/259, and due 11.</td>
    </tr>
