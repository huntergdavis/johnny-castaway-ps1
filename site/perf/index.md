...
| Stats version | mixed across rows; latest refreshed row is `walkstuf1-low-frame110-inplace-v908`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
| FISHING 1 canary | `1068 / 1072 VBlanks`, `0.0%` public over target, `100.0%` public target speed, `blocking_vb=5` |

Current W1 payload/speed track: `walkstuf1-low-frame110-inplace-v908`
shrinks low entry `110` / source frame `218` in place after the v876 frame107
trim, preserving all payload offsets while cutting that entry `4671 -> 4616`
...
`172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, and `168`, preserving offsets, pack LBA/sectors, and the PS-EXE bucket while cutting
active payload `674798 -> 670119`. Timing/CD stay exact-flat at `1602`,
...
Latest promoted BUILDING2 note: `building2-high-frame169-inplace-v896`
trims entry `169` / source frame `223` after v877/v879/v880/v887/v888/v889/v890/v891/v892 trimmed entries
`172`, `171`, `96`, `170`, `97`, `98`, `174`, `99`, and `168` and the v703 high-tide offscreen clip stack for frames `89..92`,
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building4-low-frame41-inplace-v903`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-15T04:33:38</td>
      <td>building2-high-frame169-inplace-v896</td>
      <td>+3.0%</td>
    ...
    <tr id="perf-building4-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T05:39:02</td>
      <td>building4-low-frame41-inplace-v903</td>
      <td>+1.3%</td>
      ...
      <td>34</td>
      <td>1</td>
      <td>same-speed frame41 in-place entry-size shrink preserves offsets/LBA/EXE bucket on top of v895 while cutting active payload 809364-&gt;809030; entry41/source72 shrinks 8852-&gt;8518, entry sectors 5-&gt;5, scene/loop/target stay 3128/2853/2816, overrun 37, blocking/refill 40/34, read VBlanks 215, due 1</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T06:07:16</td>
      <td>walkstuf1-low-frame110-inplace-v908</td>
      <td>+3.1%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed fixed-sector frame110 payload shrink on top of v876; entry 110/source frame 218 shrinks 4671 -&gt; 4616 bytes, active payload 790322 -&gt; 790267, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1769/1477/1432, overrun 45, blocking/refill 65/20, reads/read time 58/259, and due 11.</td>
    </tr>
