...
| Stats version | mixed across rows; latest refreshed row is `walkstuf1-high-setupseg242-388-v998`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building4-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T12:58:26</td>
      <td>building4-low-local-lz-entry270-v971</td>
      <td>+1.3%</td>
      ...
      <td>35</td>
      <td>1</td>
      <td>entry270/source410 local-LZ compresses 8287-&gt;8167 bytes in-place on top of v954, modeled entry sectors 5-&gt;4, and cuts active payload 799397-&gt;799277 while preserving pack footprint/LBA/sectors and PS-EXE bucket; material gate improves loop/target 2853/2815-&gt;2851/2815, overrun 38-&gt;36, refill 36-&gt;35, with blocking/read time/due flat at 42/223/1</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-15T14:14:21</td>
      <td>walkstuf1-high-setupseg242-388-v998</td>
      <td>+2.4%</td>
      ...
      <td>17</td>
      <td>7</td>
      <td>scene-local setup segment primes relative sectors 242..388 for WALKSTUF1 high; against v949 current control it improves active loop/target 1481/1428 -&gt; 1476/1441, overrun 53 -&gt; 35, blocking/refill 88/24 -&gt; 49/17, reads/read time 67/287 -&gt; 37/182, and due 15 -&gt; 7; setup cost rises scene 1770 -&gt; 1822 and setup bytes 413236 -&gt; 712244 inside the 4% material gate; 228..388 and split 252..388 + 228..252 crossed the structural cliff, while 252..388, 244..388, 240..388, and 241..388 were safe but slower or worse-speed boundaries.</td>
    </tr>
    <tr id="perf-walkstuf1-low">
      <td><a class="scene-perf-rowlink" href="#perf-walkstuf1-low"><code>walkstuf1</code></a></td>
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T13:49:54</td>
      <td>walkstuf1-low-setupseg238-388-v989</td>
      <td>+1.5%</td>
      ...
      <td>12</td>
      <td>4</td>
      <td>scene-local setup segment primes relative sectors 238..388 for WALKSTUF1 low; against v935 it improves active loop/target 1481/1431 -&gt; 1469/1447, overrun 50 -&gt; 22, blocking/refill 72/27 -&gt; 34/12, reads/read time 58/267 -&gt; 28/145, and due 10 -&gt; 4; setup cost rises scene 1773 -&gt; 1820 and setup bytes 421428 -&gt; 728628 inside the 4% material gate; 238..404 and 238..422 cross the clean-pressure cliff and disable prefetch, while 238..396, 232..388, and two-segment variants were safe but slower.</td>
    </tr>
