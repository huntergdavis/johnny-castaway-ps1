...
low frame-125/frame-126 resident re-anchor. The current VISITOR3 baseline is
high `1089/1035` after v214 and low `1095/1035` after v227; low cuts overrun
...
(`94.5%`); the orange band (95–99%) holds VISITOR3 high (`95.0%`), `walkstuf1`
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `visitor3-low-f125126-resident-v227`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-visitor3-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-09T12:23:07</td>
      <td>visitor3-low-f125126-resident-v227</td>
      <td>+5.8%</td>
      <td class="spd-yellow">94.5%</td>
      <td>1095/1035</td>
      <td>108</td>
      <td>0</td>
      <td>18</td>
      <td>v227 data-only reanchor frames 125/126 into accepted 150..174 low setup segment improves active loop 1098/1034 to 1095/1035, overrun 64 to 60, blocking 112 to 108, loop reads 20 to 19, due misses 19 to 18, and keeps hidden refill 0 with fixed pack LBA, fixed sound offset, and fixed PS-EXE bucket</td>
    </tr>
