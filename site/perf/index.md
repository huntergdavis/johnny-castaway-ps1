...
`walkstuf1-low-frame62-inplace-v753` then shrink frames `51`, `49`, `47`,
`61`, and `62` in-place without moving offsets, keeping timing exact-flat while
active payload drops `879801 -> 858349`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame62-inplace-v753`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:36:27</td>
      <td>walkstuf1-low-frame62-inplace-v753</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame62 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 862205-&gt;858349 and entry sectors 4-&gt;2</td>
    </tr>
