...
`206..230`, `226..242`, and `249..257` grouped-read passes plus the low `238..250`, `318..330`, and `365..381`
...
previous-frame D4 delta pass, the WALKSTUF3 high
...
resident-slot swap plus frame129 D4 delta, followed by the
WALKSTUF1 high sector `201..213`, `213..229`, `344..360`, `422..434`, and `444..456` read-group passes, the
...
Current battle-card rollup as of <time datetime="2026-05-13">2026-05-13</time>:
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `visitor3-high-frame132-setupseg1-v464`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>18</td>
      <td>7</td>
      <td>24-sector grouped-window capacity plus BUILDING2 high 206..230 row improves current high to scene 1602, loop/target 1351/1311, overrun 40, blocking 54, hidden refill 18, reads/due 58/7; BUILDING2 low, WALKSTUF1 high/low, and VISITOR3 low canaries stayed flat</td>
    </tr>
    <tr id="perf-building2-low">
      <td><a class="scene-perf-rowlink" href="#perf-building2-low"><code>building2</code></a></td>
      <td>low</td>
      <td>measured</td>
      <td>2026-05-12T22:45:20</td>
      <td>building2-low-delta-v454</td>
      <td>+2.2%</td>
      ...
      <td>0</td>
      <td>15</td>
      <td>BUILDING2 low stores frames 71 and 77 as previous-frame D4 deltas against frames 70 and 76, improving target 1319->1320, overrun 30->29, blocking 80->70, prefetch overrun 1->0, loop reads 53->52, loop-read time 227->221, and due misses 17->15 while scene/loop stay flat; BUILDING2 high, FISHING1 high, WALKSTUF1 high, and broad completed canaries stayed flat</td>
    </tr>
    ...
    <tr id="perf-visitor3-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-13T02:33:02</td>
      <td>visitor3-high-frame132-setupseg1-v464</td>
      <td>+2.7%</td>
      ...
      <td>0</td>
      <td>8</td>
      <td>frames 132 and 137 D4 previous-frame deltas plus one-sector high setup segment for frame132; loop win without hidden refill</td>
    </tr>
    <tr id="perf-visitor3-low">
      <td><a class="scene-perf-rowlink" href="#perf-visitor3-low"><code>visitor3</code></a></td>
      <td>low</td>
      <td>measured</td>
      <td>2026-05-12T22:07:59</td>
      <td>visitor3-low-frame129-delta-v452</td>
      <td>+2.6%</td>
      ...
      <td>0</td>
      <td>9</td>
      <td>custom frame129 D4 delta against moved resident frame128 improves low to 1068/1041, overrun 27, blocking 51, reads/due 9/9 with pack LBA and 217088-byte PS-EXE bucket stable; broad canaries passed</td>
    </tr>
    ...
    <tr id="perf-visitor5-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-12T15:53:59</td>
      <td>visitor5-high-current-v401</td>
      <td>+1.6%</td>
      <td class="spd-yellow">98.5%</td>
      <td>1107/1090</td>
      <td>16</td>
      <td>16</td>
      <td>0</td>
      <td>current-layout refresh after later EXE bucket/layout changes; compact FGP3 high pack with VISITOR5 auto-prime disabled remains accepted</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-12T23:36:40</td>
      <td>walkstuf1-high-current-v458-refresh</td>
      <td>+2.9%</td>
      ...
      <td>23</td>
      <td>16</td>
      <td>current-control refresh after the v457 stale-baseline check; restored source/pack baseline measures scene 1764 and active loop/target 1476/1434 with blocking 81, refill 23, reads/due 65/16</td>
    </tr>
