...
| Latest perf matrix run | `2026-05-15T03:16:52` |
| Stats version | mixed across rows; latest refreshed row is `building2-high-frame170-inplace-v887`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
Current B2-high payload track: `building2-high-frame170-inplace-v887` trims
entry `170` / source frame `226` after v877/v879/v880 trimmed entries `172`,
`171`, and `96`, preserving offsets, pack LBA/sectors, and the PS-EXE bucket while cutting
active payload `674798 -> 671529`. Timing/CD stay exact-flat at `1602`,
...
Latest promoted BUILDING2 note: `building2-high-frame170-inplace-v887`
trims entry `170` / source frame `226` after v877/v879/v880 trimmed entries
`172`, `171`, and `96` and the v703 high-tide offscreen clip stack for frames `89..92`,
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building2-high-frame170-inplace-v887`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-15T03:16:52</td>
      <td>building2-high-frame170-inplace-v887</td>
      <td>+3.0%</td>
      ...
      <td>18</td>
      <td>7</td>
      <td>same-speed preserve-offset frame170 payload shrink on top of v880; entry 170/source frame 226 shrinks 1683 -&gt; 1186 bytes, active payload 672026 -&gt; 671529, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1602/1351/1311, overrun 40, blocking/refill 54/18, reads/read time 58/257, and due 7</td>
    </tr>
