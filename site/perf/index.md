...
`walkstuf1-low-frame51-inplace-v747` and
`walkstuf1-low-frame49-inplace-v749` then shrink frames `51` and `49` in-place
without moving offsets, keeping timing exact-flat while active payload drops
`879801 -> 870484`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame49-inplace-v749`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:12:11</td>
      <td>walkstuf1-low-frame49-inplace-v749</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame49 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 874983-&gt;870484 and entry sectors 3-&gt;1</td>
    </tr>
