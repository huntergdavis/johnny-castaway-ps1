...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-cd-fastpoll-v760`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T09:58:03</td>
      <td>walkstuf1-low-cd-fastpoll-v760</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>bounded CD fast-poll restores the post-release merge regression while preserving the long-soak timeout fallback; true slow baseline was 1813/1513/1417 with blocking/refill 149/52 and PS-EXE bucket 219136, current row returns to 1770/1478/1431, overrun 47, blocking/refill 64/20, read VBlanks 272, due 11, pack LBA 25633, PS-EXE bucket 217088</td>
    </tr>
