...
entry65, entry39, entry55, entry56, and entry59 preserve-offset payload trims keep the five-yellow
canary exact-flat while reducing active low-pack payload
`788773 -> 771139`. The broader retargeted non-preserve trim was rejected
...
- **Stats Version**: performance/layout version for that row. The latest
  ...
  WALKSTUF1 low uses `w1low-trim-entry59`;
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-20T05:36:28</td>
      <td>w1low-trim-entry59</td>
      <td>1.7%</td>
