...
`walkstuf1-low-frame45-inplace-v756` then shrink frames `51`, `49`, `47`,
`61`, `62`, `58`, and `45` in-place without moving offsets, keeping timing
exact-flat while active payload drops `879801 -> 851084`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame45-inplace-v756`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:56:32</td>
      <td>walkstuf1-low-frame45-inplace-v756</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame45 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 854703-&gt;851084 and entry sectors 3-&gt;1</td>
    </tr>
