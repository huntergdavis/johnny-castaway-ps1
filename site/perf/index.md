...
Latest rejected W1 note: `walkstuf1-low-midright-ab-offscreen-v682` split the
old `85..92` mid-right miss down to `85..86`. It removed `707` pixels and
`234` spans, kept scene/loop flat at `1770/1478`, improved overrun
`47 -> 46`, but regressed blocking `64 -> 65`. Direct clipping is proven safe
at `65+` except the mid-right `85..92` cadence cliff; isolate `86` or `85`
before closing the lower pair.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-postleft-singletons-v680`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T00:09:15</td>
      <td>walkstuf1-low-postleft-singletons-v680</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed post-left singleton offscreen draw-span clipping for frames 79, 81, and 83 on top of v678 changes 3 entries, removes 1538 draw pixels and 540 spans, and drops runtime frame rows/spans/pixels 16663/122035/679951 -&gt; 16663/121495/678413 while preserving scene/loop/target 1770/1478/1431, overrun 47, blocking/refill 64/20, reads/due 62/11, pack LBA/sectors, and PS-EXE bucket</td>
    </tr>
