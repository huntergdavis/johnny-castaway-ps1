...
| Stats version | mixed across rows; latest refreshed row is `building2-high-frame96-inplace-v880`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
Current B2-high payload track: `building2-high-frame96-inplace-v880` trims
entry `96` / source frame `119` after v877/v879 trimmed entries `172` and
`171`, preserving offsets, pack LBA/sectors, and the PS-EXE bucket while cutting
active payload `674798 -> 672026`. Timing/CD stay exact-flat at `1602`,
...
Latest promoted BUILDING2 note: `building2-high-frame96-inplace-v880`
trims entry `96` / source frame `119` after v877/v879 trimmed entries `172` and
`171` and the v703 high-tide offscreen clip stack for frames `89..92`,
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building2-high-frame96-inplace-v880`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building2-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-15T02:25:57</td>
      <td>building2-high-frame96-inplace-v880</td>
      <td>+3.0%</td>
      ...
      <td>18</td>
      <td>7</td>
      <td>same-speed preserve-offset frame96 payload shrink on top of v879; entry 96/source frame 119 shrinks 8781 -&gt; 7944 bytes, active payload 672863 -&gt; 672026, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1602/1351/1311, overrun 40, blocking/refill 54/18, reads/read time 58/257, and due 7</td>
    </tr>
    ...
    <tr id="perf-walkstuf1-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-14T21:33:56</td>
      <td>walkstuf1-high-frame43-inplace-v844</td>
      <td>+2.9%</td>
      ...
      <td>23</td>
      <td>16</td>
      <td>same-speed preserve-offset frame43 payload shrink on top of v843; entry 43/source frame 53 shrinks 5555 -&gt; 2211 bytes, active payload 864830 -&gt; 861486, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1764/1476/1434, overrun 42, blocking/refill 81/23, reads/read time 63/276, and due 16</td>
    </tr>
