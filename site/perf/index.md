...
rows/spans/pixels to `16257/114854/634658`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame145-offscreen-v725`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T04:38:09</td>
      <td>walkstuf1-low-frame145-offscreen-v725</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed frame 145 offscreen draw-span clip on top of v724 preserves file size, pack LBA/sectors, PS-EXE bucket, scene/loop/target 1770/1478/1431, overrun 47, blocking/refill 64/20, reads/read time 60/274, and due 11 while trimming 916 draw pixels and 187 spans; v724/v723/v722/v721/v720/v719/v718/v717/v716 still provide the frame 130/142/6/19/131/141/5/132/133 work cuts and v705 still provides the late-tail active-payload cut 916139 -&gt; 879801 plus loop reads/read VBlanks 62/281 -&gt; 60/274 on the clean current baseline</td>
    </tr>
