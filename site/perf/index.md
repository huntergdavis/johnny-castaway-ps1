...
| Stats version | mixed across rows; latest refreshed row is `walkstuf1-low-frame91-inplace-v870`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
| FISHING 1 canary | `1068 / 1072 VBlanks`, `0.0%` public over target, `100.0%` public target speed, `blocking_vb=5` |

Current W1 payload/speed track: `walkstuf1-low-frame91-inplace-v870`
shrinks low entry `91` / source frame `166` in place after the v869 frame134
trim, preserving all payload offsets while cutting that entry `5545 -> 5387`
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame91-inplace-v870`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-15T00:53:16</td>
      <td>walkstuf1-low-frame91-inplace-v870</td>
      <td>+3.1%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed fixed-sector frame91 payload shrink on top of v869; entry 91/source frame 166 shrinks 5545 -&gt; 5387 bytes, active payload 791103 -&gt; 790945, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1769/1477/1432, overrun 45, blocking/refill 65/20, reads/read time 58/259, and due 11.</td>
    </tr>
