...
| Stats version | mixed across rows; latest refreshed row is `walkstuf1-low-frame89-inplace-v860`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
| FISHING 1 canary | `1068 / 1072 VBlanks`, `0.0%` public over target, `100.0%` public target speed, `blocking_vb=5` |

Current W1 payload/speed track: `walkstuf1-low-frame89-inplace-v860`
shrinks low entry `89` / source frame `162` in place after the speed-bearing
v859 frame87 trim, preserving all payload offsets while cutting that entry
`3792 -> 3547` bytes. Low repeats scene/loop/target at `1769/1477/1432`,
...
v860 frame89 trim keeps those metrics exact-flat while reducing payload.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame89-inplace-v860`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T23:21:42</td>
      <td>walkstuf1-low-frame89-inplace-v860</td>
      <td>+3.1%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed fixed-sector frame89 payload shrink on top of v859; entry 89/source frame 162 shrinks 3792 -&gt; 3547 bytes, active payload 792902 -&gt; 792657, file size/LBA/sectors/PS-EXE bucket stay fixed, scene/loop/target remain 1769/1477/1432, overrun 45, blocking/refill 65/20, reads/read time 58/259, and due 11.</td>
    </tr>
