...
`walkstuf1-low-frame58-inplace-v755` then shrink frames `51`, `49`, `47`,
`61`, `62`, and `58` in-place without moving offsets, keeping timing
exact-flat while active payload drops `879801 -> 854703`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame58-inplace-v755`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:47:15</td>
      <td>walkstuf1-low-frame58-inplace-v755</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame58 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 858349-&gt;854703 and entry sectors 3-&gt;1</td>
    </tr>
