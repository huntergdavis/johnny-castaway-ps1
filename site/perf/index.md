...
<p class="scene-perf-legend" aria-label="Target speed distribution as of {{ site.release.tag }}">
  ...
  <span class="spd-key spd-orange">14 (11.1%) ≥ 95%</span>
  <span class="spd-key spd-yellow">1 (0.8%) ≥ 90%</span>
...
low frame-125/frame-126 resident re-anchor plus frame-118 resident copy. The
current VISITOR3 baseline is high `1089/1035` after v214 and low `1091/1035`
after v234; low cuts overrun `60 -> 56`, blocking `108 -> 103`, loop reads
`19 -> 18`, loop-read time `115 -> 110`, and due misses `18 -> 17` while
keeping hidden refill at `0`.
Both paths keep fixed pack layout with deliberate setup tradeoffs.
The single yellow
row (90–95%) is
[`visitor3`]({{ '/scenes/visitor3/' | relative_url }}) low
(`94.9%`); the orange band (95–99%) holds VISITOR3 high (`95.0%`), `walkstuf1`
high/low (`95.6%` / `95.8%`), BUILDING2 high/low, VISITOR5 high/low, JOHNNY1 high/low,
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `visitor3-low-f118-resident-copy-v234`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-activity9-low">
      ...
      <td>12</td>
      <td>1</td>
      <td>Compact FGP3/v4 restore-minus-current low-tide pack; preserves footprint, LBA, sectors, and PS-EXE bucket</td>
    </tr>
    ...
    <tr id="perf-building2-low">
      ...
      <td>1</td>
      <td>19</td>
      <td>restore-minus-current low pack plus 4-VBlank slack guard; exact-flat in ACTIVITY9 low broad gate</td>
    </tr>
    ...
    <tr id="perf-visitor3-high">
      ...
      <td>high</td>
      <td>measured</td>
      <td>2026-05-09T10:00:28</td>
      <td>visitor3-high-setup-prime320-v214</td>
      <td>+5.2%</td>
      ...
      <td>0</td>
      <td>15</td>
      <td>v214 high-only setup prime 288KiB->320KiB improves active loop: 1099/1032->1089/1035 overrun 67->54 blocking 96->83 loop reads 17->15 due misses 17->15; low and broad controls flat; fixed pack LBA and PS-EXE bucket</td>
    </tr>
    <tr id="perf-visitor3-low">
      <td><a class="scene-perf-rowlink" href="#perf-visitor3-low"><code>visitor3</code></a></td>
      <td>low</td>
      <td>measured</td>
      <td>2026-05-09T13:19:40</td>
      <td>visitor3-low-f118-resident-copy-v234</td>
      <td>+5.4%</td>
      <td class="spd-yellow">94.9%</td>
      <td>1091/1035</td>
      <td>103</td>
      <td>0</td>
      <td>17</td>
      <td>v234 copies frame 118 payload unchanged into accepted 150..174 low setup segment, preserving cadence/render semantics while improving active loop 1095/1035 to 1091/1035, overrun 60 to 56, blocking 108 to 103, loop reads 19 to 18, due misses 18 to 17, and keeping hidden refill 0 with fixed pack LBA, fixed sound offset, and fixed PS-EXE bucket</td>
    </tr>
