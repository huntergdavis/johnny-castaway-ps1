...
`walkstuf1-low-frame47-inplace-v750` then shrink frames `51`, `49`, and `47`
in-place without moving offsets, keeping timing exact-flat while active payload
drops `879801 -> 866243`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame47-inplace-v750`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:21:23</td>
      <td>walkstuf1-low-frame47-inplace-v750</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame47 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 870484-&gt;866243 and entry sectors 5-&gt;3</td>
    </tr>
