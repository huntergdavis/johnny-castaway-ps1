...
`walkstuf1-low-frame51-inplace-v747` then shrinks frame `51` in-place without
moving offsets, keeping timing exact-flat while active payload drops
`879801 -> 874983`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame51-inplace-v747`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T08:03:07</td>
      <td>walkstuf1-low-frame51-inplace-v747</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame51 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 879801-&gt;874983 and entry sectors 4-&gt;1</td>
    </tr>
