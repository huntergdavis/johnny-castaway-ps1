...
`walkstuf1-low-frame37-inplace-v757` then shrink frames `51`, `49`, `47`,
`61`, `62`, `58`, `45`, and `37` in-place without moving offsets, keeping
timing exact-flat while active payload drops `879801 -> 847643`.
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `walkstuf1-low-frame37-inplace-v757`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T09:03:16</td>
      <td>walkstuf1-low-frame37-inplace-v757</td>
      <td>+3.3%</td>
      ...
      <td>20</td>
      <td>11</td>
      <td>same-speed in-place frame37 entry-size shrink preserves offsets/LBA/EXE bucket while cutting active payload 851084-&gt;847643 and entry sectors 4-&gt;2</td>
    </tr>
