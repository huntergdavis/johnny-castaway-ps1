...
VISITOR3 motion-copy/code-headroom/CD-pressure passes plus the low persistent
setup-segment pass. The latest VISITOR3 pass keeps high at `1101/1030` and
moves low `1108/1028 -> 1102/1032`; blocking is now `114/124` with fixed pack
layout and a deliberate low setup tradeoff.
The two yellow
rows (90–95%) are
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `visitor3-low-segment281-305-v204`,
