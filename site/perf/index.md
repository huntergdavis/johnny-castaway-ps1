...
| Stats version | mixed across rows; latest refreshed row is `building4-low-frame35-inplace-v808`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building4-low-frame35-inplace-v808`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building4-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T16:45:06</td>
      <td>building4-low-frame35-inplace-v808</td>
      <td>+1.3%</td>
