...
entry65, entry39, entry55, and entry56 preserve-offset payload trims keep the five-yellow
canary exact-flat while reducing active low-pack payload
`788773 -> 774883`. The broader retargeted non-preserve trim was rejected
...
- **Stats Version**: performance/layout version for that row. The latest
  ...
  WALKSTUF1 low uses `w1low-trim-entry56`;
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-walkstuf1-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-20T05:09:26</td>
      <td>w1low-trim-entry56</td>
      <td>1.7%</td>
