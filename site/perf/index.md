...
| Stats version | mixed across rows; latest refreshed row is `building4-low-frame37-inplace-v813`; per-row version is in the [`Stats Version` column below](#reading-the-table). |
...
- **Stats Version**: performance/layout version for that row. The latest
  refreshed rows use `building4-low-frame37-inplace-v813`,
...
<table class="scene-perf-table">
  ...
  <tbody>
    ...
    <tr id="perf-building4-low">
      ...
      <td>low</td>
      <td>measured</td>
      <td>2026-05-14T17:02:35</td>
      <td>building4-low-frame37-inplace-v813</td>
      <td>+1.3%</td>
