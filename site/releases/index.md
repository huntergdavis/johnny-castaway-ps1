...
- **Battle card is now public-capped at native speed.** After the follow-up
  ...
  passes through v237, all 126 timing-bearing rows average `+0.3697%` public
  over target / `99.6402%` public target speed; the raw signed CSV is
  `-0.3988%` / `100.4240%` for
  optimization work.
- **VISITOR3 motion-copy payloads are promoted.** Frames `119..123` in both
  ...
  the low frame-118/frame-127 resident copies now
  ...
  1089/1035`, low improves `1126/1025 -> 1088/1035`, blocking drops
  `150/170 -> 83/95`, and the packs
