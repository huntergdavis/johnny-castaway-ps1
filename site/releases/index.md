...
- **Battle card is now public-capped at native speed.** After the follow-up
  ...
  VISITOR3 motion-copy/code-headroom/CD-pressure passes through v206, all 126
...
- **VISITOR3 motion-copy payloads are promoted.** Frames `119..123` in both
  ...
  high-only frame `117`, and high-only re-anchored frames `127`/`126` now move
