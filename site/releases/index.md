...
- **Battle card is now public-capped at native speed.** After the follow-up
  ...
  passes through v234, all 126 timing-bearing rows average `+0.3720%` public
  over target / `99.6381%` public target speed; the raw signed CSV is
  `-0.3965%` / `100.4219%` for
  optimization work.
- **VISITOR3 motion-copy payloads are promoted.** Frames `119..123` in both
  ...
  the low frame-118 resident copy now
  ...
  1089/1035`, low improves `1126/1025 -> 1091/1035`, blocking drops
  `150/170 -> 83/103`, and the packs
