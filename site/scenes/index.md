...
<table class="scene-table perf-rollup-table">
  <thead>
    <tr>
      <th>Metric</th>
      <th>Value</th>
  ...
  <tbody>
    <tr>
      <td>Scenes visually validated</td>
      <td><code>{{ validated_count }} / {{ total_count }}</code></td>
    </tr>
    <tr>
      <td>Validated scenes</td>
      <td>all 63 original scenes; see the live ledger above for the source rows</td>
    </tr>
    <tr>
      <td>Scene/tide variants routed through headless perf</td>
      <td><code>126 / 126</code></td>
    </tr>
    <tr>
      <td>Timing-bearing variants</td>
      <td><code>120 / 126</code></td>
    </tr>
    <tr>
      <td>Scenes with at least one active-loop timed variant</td>
      <td><code>60 / 63</code></td>
    </tr>
    <tr>
      <td>Scenes with both high/low variants measured</td>
      <td><code>63 / 63</code></td>
    </tr>
    <tr>
      <td>Pending variants</td>
      <td><code>0 / 126</code></td>
    </tr>
    <tr>
      <td>Blocked variants</td>
      <td><code>0 / 126</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>1069 / 1072 VBlanks</code>, <code>-0.3%</code>, <code>100.3% target speed</code>, <code>blocking_vb=5</code></td>
    </tr>
  </tbody>
</table>
...
<table class="scene-table perf-battle-card">
  <thead>
    <tr>
      <th>Scene</th>
      <th>Tide</th>
