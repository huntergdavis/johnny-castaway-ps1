...
the VISITOR3 high frame139 raw-gap promotion; all 63 scenes remain validated, all 126 high/low rows are timing-bearing, and the public headless battle card is +0.2994% over target / 99.7069% target speed).
