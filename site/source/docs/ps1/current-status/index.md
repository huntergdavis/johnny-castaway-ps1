...
current VISITOR3 offscreen draw clips, BUILDING4 restore-minus-current pack baseline, WALKSTUF1 high setup-prime retune, and BUILDING2 high/low grouped read work; all 63 scenes remain validated, and the headless battle card is under target at -0.0670% over / 100.1368% target speed).
