...
VISITOR 5, and VISITOR 6 were validated after generic multi-view capture. VISITOR6 also uses full-host impact-delta injection for the background-owned coconut/tree impact frames).
