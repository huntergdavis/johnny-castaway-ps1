...
This is the website shelf page for [`docs/ps1/freeplay-mode-design.md`]({{ site.github_url }}/blob/main/docs/ps1/freeplay-mode-design.md).
...
- [Open the source file on GitHub]({{ site.github_url }}/blob/main/docs/ps1/freeplay-mode-design.md)
