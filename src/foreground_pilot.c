...
#define FG_WALKSTUF1_LOW_SETUP_SEGMENT_START (244UL * FG_CD_SECTOR_SIZE)
#define FG_WALKSTUF1_LOW_SETUP_SEGMENT_BYTES (106UL * FG_CD_SECTOR_SIZE)
#define FG_WALKSTUF1_LOW_SETUP_SEGMENT2_START (179UL * FG_CD_SECTOR_SIZE)
...
#define FG_VISITOR3_HIGH_SETUP_SEGMENT2_BYTES (26UL * FG_CD_SECTOR_SIZE)
#define FG_VISITOR3_HIGH_SETUP_SEGMENT3_START (228UL * FG_CD_SECTOR_SIZE)
#define FG_VISITOR3_HIGH_SETUP_SEGMENT3_BYTES (34UL * FG_CD_SECTOR_SIZE)
